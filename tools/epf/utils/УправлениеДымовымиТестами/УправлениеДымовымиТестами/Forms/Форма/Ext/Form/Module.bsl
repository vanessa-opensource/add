...
Процедура ЗаполнитьJSONНастроек(ЗаписьJSON)
	...
	СоответствиеНастроек.Вставить(КлючНастройкиОткрытиеФорм(), НастройкиОткрытияФорм);
	
	ЗаписатьНастройкуПоКлючу(КлючНастройкиМодальныеОкна(), СоответствиеНастроек);
	ЗаписатьНастройкуПоКлючу(КлючНастройкиКомандныйИнтерфейс(), СоответствиеНастроек);
	ЗаписатьНастройкуПоКлючу(КлючНастройкиМакетыСКД(), СоответствиеНастроек);
	ЗаписатьНастройкуПоКлючу(КлючНастройкиПроведениеДокументов(), СоответствиеНастроек);
	ЗаписатьНастройкуПоКлючу(КлючНастройкиФормированиеПечатныхФорм(), СоответствиеНастроек);
