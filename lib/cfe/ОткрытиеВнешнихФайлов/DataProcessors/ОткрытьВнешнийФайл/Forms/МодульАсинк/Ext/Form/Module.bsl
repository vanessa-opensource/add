//TODO добавить метод ПроверитьРасширениеРаботыСФайламиВебКлиент()
...
Процедура НачатьПомещениеФайла_8_3_15_и_Выше(ОписаниеОповещенияОЗавершении, АдресХранения, ПомещаемыйФайл, Интерактивно,
	...
	Выполнить("НачатьПомещениеФайлаНаСервер(ОписаниеОповещения, , , АдресХранения, ИмяФайла, Идентификатор);");
КонецПроцедуры
...
Функция СтроковыеУтилиты()
	...
	Возврат ПолучитьФорму("Обработка.СтроковыеУтилиты.Форма");
