...
Функционал: Проверка возможности отладки кода обработок в управляемых формах
	...
	Когда я вручную открыл форму VanessaADD
  ...
  И при нахождении в заголовке "VanessaADD" поптыталась бы вызвать экспортную функцию 'ДобавитьВнешнийСписокПроцедур'
  ...
  И я вручную открыл форму VanessaADD
  Тогда VanessaADD автоматически просканировала все открытые формы
