...
#	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'я открываю выпадающий список "Реквизит1"'
	Если Версия платформы ">=" "8.3.7" Тогда
		Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'из выпадающего списка "Реквизит1" я выбираю по строке \'ЗначениеПеречисления1\''
	...
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'И в таблице "ТабличнаяЧасть1" я нажимаю на кнопку \'Добавить\''

	Если Версия платформы ">=" "8.3.7" Тогда
		Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "ТабличнаяЧасть1" из выпадающего списка "Реквизит справочник" я выбираю по строке \'ТестовыйЭлемент21\''
	...
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "Список" я выбираю текущую строку'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'открылось окно "Тестовый Элемент * (Справочник1) *"'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "ТабличнаяЧасть1" из выпадающего списка "Реквизит справочник выбор из формы списка" я выбираю точное значение \'ТестовыйЭлемент21\''
