...
#Область Проверка работы генератора шагов
	...
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'В панели разделов я выбираю "Основная"'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'открылось окно "Справочник1"'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка ' в таблице "Список" я выбираю текущую строку'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'открылось окно "Тестовый Элемент * (Справочник1)"'
#	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'я открываю выпадающий список "Реквизит1"'
	Если Версия платформы ">=" "8.3.7" Тогда
		Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'из выпадающего списка с именем "Реквизит1" я выбираю по строке \'ЗначениеПеречисления1\''

	Если Версия платформы "<" "8.3.12" Тогда
		Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'я выбираю значение реквизита "Реквизит2" из формы списка'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'открылось окно "Справочник2"'

	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "Список" я выбираю текущую строку'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'открылось окно "Тестовый Элемент * (Справочник1) *"'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'я изменяю флаг "Реквизит булево"'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "ТабличнаяЧасть1" я нажимаю на кнопку с именем "ТабличнаяЧасть1Добавить"'

	Если Версия платформы ">=" "8.3.7" Тогда
		Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "ТабличнаяЧасть1" из выпадающего списка с именем "ТабличнаяЧасть1РеквизитСправочник" я выбираю по строке \'ТестовыйЭлемент21\''
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "ТабличнаяЧасть1" я изменяю флаг "Реквизит булево"'
	Если Версия платформы "<" "8.3.12" Тогда
		Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "ТабличнаяЧасть1" я выбираю значение реквизита с именем "ТабличнаяЧасть1РеквизитСправочникВыборИзФормыСписка" из формы списка'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'открылось окно "Справочник2"'

	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "Список" я выбираю текущую строку'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'открылось окно "Тестовый Элемент * (Справочник1) *"'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "ТабличнаяЧасть1" из выпадающего списка с именем "ТабличнаяЧасть1РеквизитСправочникВыборИзФормыСписка" я выбираю точное значение \'ТестовыйЭлемент21\''
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'в таблице "ТабличнаяЧасть1" я завершаю редактирование строки'
	Тогда В реквизите Vanessa-ADD "СгенерированныйСценарий" будет содержаться строка 'я нажимаю на кнопку "Записать и закрыть"'
