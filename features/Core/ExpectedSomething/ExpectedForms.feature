...
#Область Создание элементов шапки
	...
	И я запоминаю значение поля с именем "РеквизитСтрока" как "ЗначениеПоляРеквизитСтрока"
	И я перехожу к следующему реквизиту
	...
	И я активизирую поле с именем "РеквизитСтрока"
	И в поле с именем "РеквизитСтрока" я ввожу текст "$ЗначениеПоляРеквизитСтрока2$"
...
Сценарий: Проверка наличия строк в таблице по шаблону
	...
	Тогда в таблице есть строки, в т.ч. и многострочные, указанные по простому шаблону - * в начале и\или конце строки
	...
	Тогда в таблице нет строк, в т.ч. и многострочных, указанных по простому шаблону - * в начале и\или конце строки
	...
	Тогда в таблице есть строки, в т.ч. и многострочные, указанные по более сложному шаблону - * в середине строки
		...
		Тогда таблица "ТабличнаяЧасть1" содержит строки:
			...
			| 'много*ая'                   |
	Тогда в таблице нет строк, в т.ч. и многострочных, указанные по более сложному шаблону - * в середине строки
		Тогда таблица "ТабличнаяЧасть1" не содержит строки:
			| Реквизит строка |
			| 'пер*ая'      	  |
		Тогда таблица "ТабличнаяЧасть1" не содержит строки:
	...
	Тогда в таблице есть строки, в т.ч. и многострочные, указанные по более сложному шаблону - несколько * в строке
		Тогда таблица "ТабличнаяЧасть1" содержит строки:
			| Реквизит строка |
			| '*пер*ая*'      	  |
		Тогда таблица "ТабличнаяЧасть1" стала равной по шаблону:
