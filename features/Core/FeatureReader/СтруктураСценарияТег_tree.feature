...
Сценарий: Передач параметра во вложенный сценарий первого и второго уровня
	...
	И     таблица формы с именем "ДеревоТестов" стала равной:
		...
		| 'Когда первый шаг <ШК>'                                 | 'ПервыйШаг(ШК)'                                                                 |
		| 'Когда шаг дерево'                                      | ''                                                                              |
		| 'И финальный шаг <ШК>'                                  | 'ФинальныйШаг(ШК)'                                                              |
		| 'Примеры'                                               | ''                                                                              |
		| '\| ШК              \|'                                 | ''                                                                              |
		| '\| '2200001008004' \|'                                 | ''                                                                              |
		| 'Когда первый шаг "2200001008004"'                      | 'ПервыйШаг(ШК)'                                                                 |
		| 'Когда шаг дерево'                                      | ''                                                                              |
		| 'И финальный шаг "2200001008004"'                       | 'ФинальныйШаг(ШК)'                                                              |
		| '\| 2200001015504   \|'                                 | ''                                                                              |
		| 'Когда первый шаг 2200001015504'                        | 'ПервыйШаг(ШК)'                                                                 |
		| 'Когда шаг дерево'                                      | ''                                                                              |
		| 'И финальный шаг 2200001015504'                         | 'ФинальныйШаг(ШК)'                                                              |
