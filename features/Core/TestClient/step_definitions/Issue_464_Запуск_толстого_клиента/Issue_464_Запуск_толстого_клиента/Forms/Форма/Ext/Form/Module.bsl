...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧДанныеКлиентовТестированияVanessaADDСодержитсяСтрока(ТабПарам)","ВТЧДанныеКлиентовТестированияVanessaADDСодержитсяСтрока","И     в ТЧ ДанныеКлиентовТестирования VanessaADD содержится строка:");
...
&НаКлиенте
//И     в ТЧ ДанныеКлиентовТестирования VanessaADD содержится строка:
//@ВТЧДанныеКлиентовТестированияVanessaADDСодержитсяСтрока(ТабПарам)
Процедура ВТЧДанныеКлиентовТестированияVanessaADDСодержитсяСтрока(ТабПарам) Экспорт
