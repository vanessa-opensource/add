...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТЧДанныеКлиентовТестированияVanessaADDСодержитьсяСтрока(ТабПарам)","ВТЧДанныеКлиентовТестированияVanessaADDСодержитьсяСтрока","И     в ТЧ ДанныеКлиентовТестирования VanessaADD содержиться строка:");
...
&НаКлиенте
//И     в ТЧ ДанныеКлиентовТестирования VanessaADD содержиться строка:
//@ВТЧДанныеКлиентовТестированияVanessaADDСодержитьсяСтрока(ТабПарам)
Процедура ВТЧДанныеКлиентовТестированияVanessaADDСодержитьсяСтрока(ТабПарам) Экспорт
	...
	Если НайденныеСтрока.Количество() > 0 Тогда
		...
		Если ЗначениеЗаполнено(ПутьКПлатформе) Тогда
			Если Не Ванесса.ЭтоЛинукс() Тогда
