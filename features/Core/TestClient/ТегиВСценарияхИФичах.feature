...
Чтобы я мог использовать фильтры по фичам и сценариям


Контекст:
	Когда Я открываю VanessaADD в режиме TestClient
	И     В поле с именем "КаталогФичСлужебный" я указываю путь к каталогу фич "Support\Templates\ФичиДляПроверкиРаботыТегов"
...
Сценарий: Исключение по тегу сценария когда идёт загрузка одной фичи
	...
	И     В поле с именем "КаталогФичСлужебный" я указываю путь к каталогу фич "Support\Templates\ФичиДляПроверкиРаботыТегов\ТегВторойСценарий.feature"
	И Я нажимаю на кнопку перезагрузить сценарии в Vanessa-ADD TestClient

	Когда Я нажимаю на кнопку выполнить сценарии в Vanessa-ADD TestClient
...
Сценарий: Проверка работы отбора тега фичи
	...
	И     В форме "Список значений" в ТЧ "ValueList" я завершаю редактирование строки
	И     я нажимаю на кнопку "ОК"
	Когда Я нажимаю на кнопку перезагрузить сценарии в Vanessa-ADD TestClient
