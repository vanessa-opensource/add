...
Функционал: инструкция по загрузки фич во фреймворк Vanessa-ADD
	Как Разработчик
	Я Хочу чтобы я мог загрузить нужные мне фичи во фреймворк Vanessa-ADD
	Чтобы я мог их потом запустить на выполнение

Контекст:
	Дано Я открываю Vanessa-ADD в TestClient без загрузки сохраненных настроек
