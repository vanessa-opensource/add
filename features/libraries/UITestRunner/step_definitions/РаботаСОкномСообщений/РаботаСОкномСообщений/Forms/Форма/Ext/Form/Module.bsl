...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВЛогеСообщенийTestClientЕстьСтрока(Парам01)","ВЛогеСообщенийTestClientЕстьСтрока","Когда в логе сообщений TestClient есть строка ""Нужное сообщение пользователю""","Проверяет в логе сообщений наличие нужной строки. Возможно использование шаблонных символов * для пропуска любых символов.","UI.Сообщения пользователю");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВЛогеСообщенийTestClientЕстьСтроки(ТабПарам)","ВЛогеСообщенийTestClientЕстьСтроки","Когда в логе сообщений TestClient есть строки:" + Символы.ПС + "	| 'Сообщение1' |" + Символы.ПС + "	| 'Сообщение2' |","Проверяет в логе сообщений наличие нужной строки. Возможно использование шаблонных символов * для пропуска любых символов.","UI.Сообщения пользователю");
...
Процедура ВЛогеСообщенийTestClientЕстьСтрока(Стр) Экспорт
	...
	Для каждого Сообщение Из МассивСообщений Цикл
		СообщениеНРег = НРег(Сообщение);
		Если Найти(СообщениеНРег, СтрНРег) > 0 
			Или Ванесса.СтрокаСоответствуетШаблону(СообщениеНРег, СтрНРег) Тогда
