...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ВТЧИзВыпадающегоСпискаЯВыбираюСВыбором(Парам01,Парам02,Парам03)", "ВТЧИзВыпадающегоСпискаЯВыбираюСВыбором", "И В таблице ""ИмяТаблицы"" из выпадающего списка ""ИмяПоля"" я выбираю ""ЗначениеПоля"" с выбором", "", "UI.Таблицы.Реквизиты");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ВПолеСИменемЯВвожуНачалоТекущегоМесяца(Парам01)", "ВПолеСИменемЯВвожуНачалоТекущегоМесяца", "И в поле с именем ""ИмяПоля"" я ввожу начало текущего месяца", "Вводит в поле текстовое представление значения даты равной началу текущего месяца. Например ""01.01.2018"".", "UI.Формы.Поля.Ввод даты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ВПолеСИменемЯВвожуКонецТекущегоМесяца(Парам01)", "ВПолеСИменемЯВвожуКонецТекущегоМесяца", "И в поле с именем ""ИмяПоля"" я ввожу конец текущего месяца", "Вводит в поле текстовое представление значения даты равной концу текущего месяца. Например ""31.01.2018"".", "UI.Формы.Поля.Ввод даты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ВПолеСИменемЯВвожуНачалоСледующегоМесяца(Парам01)", "ВПолеСИменемЯВвожуНачалоСледующегоМесяца", "И в поле с именем ""ИмяПоля"" я ввожу начало следующего месяца", "Вводит в поле текстовое представление значения даты равной началу следующего месяца. Например ""01.01.2018"".", "UI.Формы.Поля.Ввод даты");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ВПолеСИменемЯВвожуКонецСледующегоМесяца(Парам01)", "ВПолеСИменемЯВвожуКонецСледующегоМесяца", "И в поле с именем ""ИмяПоля"" я ввожу конец следующего месяца", "Вводит в поле текстовое представление значения даты равной концу следующего месяца. Например ""31.01.2018"".", "UI.Формы.Поля.Ввод даты");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ПолеПрисутствуетНаФорме(Парам01)", "ПолеПрисутствуетНаФорме", "И поле ""Имя поля"" присутствует на форме", "", "UI.Формы.Поля.Проверка существования");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ПолеСИменемПрисутствуетНаФорме(Парам01)", "ПолеСИменемПрисутствуетНаФорме", "И поле с именем ""ИмяПоля"" присутствует на форме", "", "UI.Формы.Поля.Проверка существования");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ПолеОтсутствуетНаФорме(Парам01)", "ПолеОтсутствуетНаФорме", "И поле ""Имя поля"" отсутствует на форме", "", "UI.Формы.Поля.Проверка существования");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ПолеСИменемОтсутствуетНаФорме(Парам01)", "ПолеСИменемОтсутствуетНаФорме", "И поле с именем ""ИмяПоля"" отсутствует на форме", "", "UI.Формы.Поля.Проверка существования");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЕстьЭлементСправочникаСНаименованиемИРеквизитомРавным(Парам01,Парам02,Парам03,Парам04)", "ЕстьЭлементСправочникаСНаименованиемИРеквизитомРавным", "И     Есть элемент справочника ""ИмяФормы"" с наименованием ""Тест"" и  реквизитом ""ИмяПоля"" равным ""Группа2Элем2""", "", "Данные.Справочники");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ПеременнаяИмеетЗначение(Парам01,Парам02)", "ПеременнаяИмеетЗначение", "Тогда переменная ""ИмяПеременной"" имеет значение ""ЗначениеПеременной""", "Проверяет значение переменной контекста. Возможно использовать шаблонный знак * для пропуска символов.", "Контекст.Контекст.Прочитать значение", "Условие");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ЗначениеПоляРавноЗначениюИзМакета(Парам01,Парам02)", "ЗначениеПоляРавноЗначениюИзМакета", "И значение поля ""ИмяПоля"" равно значению из макета ""Xml_1En""", "", "UI.Формы.Поля.Проверка значения поля");
...
Функция НайтиФормыТекущегоОкна(ДопПараметры = Неопределено)
	Возврат Ванесса.НайтиФормыТекущегоОкнаТестКлиента(ДопПараметры);
КонецФункции

&НаКлиенте
Функция НайтиТекущуюФорму()
	Возврат Ванесса.НайтиТекущуюФормуТестКлиента();
КонецФункции
...
Процедура ЕслиНаЭкранеДиалогМодальныйДиалогТоНадоЕгоЗакрыть()
	...
	ОкнаПриложения = Ванесса.НайтиВсеОкнаТестКлиента();
	...
	Для Каждого Кнопка Из МассивКнопок Цикл
		ТекстЗаголовкаНРег = НРег(Кнопка.ТекстЗаголовка);
		Если ТекстЗаголовкаНРег = "нет" Тогда
			Кнопка.Нажать();
			Возврат;
		ИначеЕсли ТекстЗаголовкаНРег = "no" Тогда
			Кнопка.Нажать();
			Возврат;
		ИначеЕсли ТекстЗаголовкаНРег = "отмена" Тогда
			Кнопка.Нажать();
			Возврат;
		ИначеЕсли ВРег(Кнопка.ТекстЗаголовка) = "OK" Тогда
			Кнопка.Нажать();
			Возврат;
		ИначеЕсли ТекстЗаголовкаНРег = "закрыть" Тогда
			//для форм БСП
			Кнопка.Нажать();
			Возврат;
		КонецЕсли;
...
Процедура ЯЗакрылВсеОкнаКлиентскогоПриложенияКроме(ЗаголовокОкна) Экспорт
	...
	НужноеОкно     = Ванесса.НайтиОкноТестКлиентаПоЗаголовку(ЗаголовокОкна);

	ЕслиНаЭкранеДиалогМодальныйДиалогТоНадоЕгоЗакрыть(); //диалог мог остаться от предыдущего сценария

	Итерация = 1;
	ЗакрытьОкнаПродолжение(НужноеОкно, ОкнаПриложения, Итерация);
КонецПроцедуры

&НаКлиенте
Процедура ЗакрытьОкнаПродолжение(НужноеОкно, ОкнаПриложения, Итерация)
	ЛимитИтераций = 3;
	Если Итерация > ЛимитИтераций Тогда
		Возврат;
	КонецЕсли;
	Итерация = Итерация + 1;
	...
	Для каждого ОкноПриложение Из ОкнаПриложения Цикл
		...
		Попытка
			ОкноПриложение.Закрыть();
		Исключение
			ТекстСообщения = "Не смог закрыть окно %1 с %2 попытки";
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%1", ОкноПриложение);
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%2", Итерация);
			Сообщить(ТекстСообщения);
			Продолжить;
		КонецПопытки;
		ЕслиНаЭкранеДиалогМодальныйДиалогТоНадоЕгоЗакрыть(); //диалог мог появиться при закрытии окна.
	...
	Если ОкнаПриложения.Количество() > 2 Тогда
		ЗакрытьОкнаПродолжение(НужноеОкно, ОкнаПриложения, Итерация)
	КонецЕсли;
КонецПроцедуры
...
Процедура ОткрылосьОкно(Знач ИмяОкна, ЧастьИмени2 = Неопределено
	...
	Если Ванесса.ЭтоЗаголовокОкнаМодальногоДиалога(ИмяОкна)
			...
			Тогда
		АктивноеОкно = Ванесса.НайтиОкноТестКлиентаПоЗаголовку(ИмяОкна);
	...
	Иначе
		...
		АктивноеОкно2 = Ванесса.НайтиОкноТестКлиентаПоЗаголовку(ИмяОкна);
		...
		Если Не ЭтоМодальныйДиалогПлатформы Тогда
			Если АктивноеОкно.Заголовок <> АктивноеОкно2.Заголовок Тогда
				Если КоличествоПопытокПоискаОкон = 0 Тогда
					ТестоваяПеременная = Ванесса.НайтиОкноТестКлиентаПоЗаголовку(Строка(Новый УникальныйИдентификатор), ,
						2);//TODO заменить 2 на 1 секунду поиска окна
...
// 	НужноеОкно = Ванесса.НайтиОкноТестКлиентаПоЗаголовку(ЗначениеОбрабткаОжидания);
...
Процедура ЯЖдуЗакрытияОкнаВТеченииСекунд(ИмяОкна, КоличествоСекунд) Экспорт
	...
	Пока  (ТекущаяДата() - ДатаНачалаОбработкиОжидания) < КоличествоСекундОбработкаОжидания Цикл
		...
		НужноеОкно = Ванесса.НайтиОкноТестКлиентаПоЗаголовку(ЗначениеОбрабткаОжидания, 1);
...
Процедура ЯЖдуОткрытияОкнаВТеченииСекундОбработчикОжидания()
	...
	ПодключитьОбработчикОжидания("ЯЖдуОткрытияОкнаВТеченииСекундОбработчикОжидания", 0.1, Истина);
КонецПроцедуры
...
Функция ПолучитьОшибкаНетКолонок(ИмяТЧ, ТабПарам)
	...
	Попытка
		// ПолучитьПодчиненныеОбъекты не сработает, так как возвращает только объекты, непосредственно
		// подчиненные таблице.
	...
	Для Каждого Элем Из ТабПарам[0] Цикл
		ИскомыйЗаголовокТаблицы = СтрЗаменить(Элем.Значение, "\n", " ");
...
Процедура ВФормеВТаблицеЯПерехожуКСтроке(ИмяФормы, ИмяТЧ, ТабПарам) Экспорт
	...
	Если НЕ ПолучилосьПерейти Тогда
		Попытка
			//Возможно, это  ошибка платформы. Такое бывает с таблицами значений в УФ. Смотри https://github.com/vanessa-opensource/vanessa-behavior/issues/342
		...
		Если ДопПараметры.Свойство("АктивноеОкно") Тогда
			Если ДопПараметры.АктивноеОкно <> Неопределено Тогда
				Если Ванесса.ЭтоЗаголовокОкнаМодальногоДиалога(ДопПараметры.АктивноеОкно.Заголовок) Тогда
					...
					ОкнаПредупреждений = Ванесса.НайтиОкноТестКлиентаПоЗаголовку("1С:Предприятие");
...
Функция ПроверитьЗначениеРеквизитаСправочника(ИмяСпр, Наименование, ИмяРек, СтроковоеПредставление)
	Элем = Справочники[ИмяСпр].НайтиПоНаименованию(Наименование, Истина);
	Если Не ЗначениеЗаполнено(Элем) Тогда
		Возврат Ложь;
	КонецЕсли;

	Если СокрЛП(Элем[ИмяРек]) <> СтроковоеПредставление Тогда
		Возврат Ложь;
	КонецЕсли;
...
Процедура ЕстьЭлементСправочникаСНаименованиемИРеквизитомРавным(ИмяСпр, Наименование, ИмяРек, СтроковоеПредставление) Экспорт
	ТекстСообщения = "Не нашел значение реквизита у спр: ИмяСпр=%1, Наименование=%2, ИмяРек=%3, СтроковоеПредставление=%4";
	...
	Ванесса.ПроверитьРавенство(ПроверитьЗначениеРеквизитаСправочника(ИмяСпр, Наименование, ИмяРек, СтроковоеПредставление), Истина, ТекстСообщения);
КонецПроцедуры
...
Процедура ТаблицаФормыСИменемСталаРавной(ИмяТЧ, ТабПарам, ДопПараметры = Неопределено) Экспорт
	...
	Для Ккк = 1 По ТабПарам.Количество() - 1 Цикл //в первой строке шапка
		...
		Для каждого Колонка Из СтрокаШапки Цикл
			...
			ИмяКолонкиСтарое = ЗаменитьПробельныеСимволы(ИмяКолонкиСтарое);
			...
			ЗначСтарое = ЗаменитьПробельныеСимволы(ЗначСтарое);
...
&НаСервереБезКонтекста
Функция ЗаменитьПробельныеСимволы(Знач Значение)
...
Функция ПолучитьТЗПроверяемыхДанных(ТабПарам)
	...
	ИндексДубликатов = 0;
	Для каждого Колонка Из СтрокаШапки Цикл
		ИмяИсходнойКолонки = Колонка.Ключ;
		ЗаголовокКолонки = Колонка.Значение;

		ИмяКолонки = УбратьВсеЗапрещенныеСимволы(ЗаголовокКолонки);
		ЕстьДубльКолонки = ЗаголовкиКолонок.Получить(ИмяКолонки) <> Неопределено;
		Если ЕстьДубльКолонки Тогда
			ИмяКолонки = ИмяКолонки + Формат(ИндексДубликатов, "ЧГ=");
			ИндексДубликатов = ИндексДубликатов  + 1;
		КонецЕсли;
		ЗаголовкиКолонок.Вставить(ИмяКолонки, ЗаголовокКолонки);
		КолонкиШапки.Вставить(ИмяИсходнойКолонки, ИмяКолонки);

		ТЗБыло.Колонки.Добавить(ИмяКолонки, Новый ОписаниеТипов("Строка"));

	КонецЦикла;

	Для СтрокаБыло = 1 По ТабПарам.Количество() - 1 Цикл //в первой строке шапка
		СтрокаИсходнойТаблицы = ТабПарам[СтрокаБыло];
		СтрокаТЗБыло = ТЗБыло.Добавить();
		Для каждого Колонка Из КолонкиШапки Цикл
			ИмяИсходнойКолонки = Колонка.Ключ;
			ИмяКолонкиСтарое = Колонка.Значение;
			ЗначениеБыло = Неопределено;
			СтрокаИсходнойТаблицы.Свойство(ИмяИсходнойКолонки, ЗначениеБыло);
			СтрокаТЗБыло[ИмяКолонкиСтарое] = ЗаменитьПробельныеСимволы(ЗначениеБыло);
		КонецЦикла;
	КонецЦикла;
...
Функция ПолучитьТЗТекущихДанных(ЗначениеТЧ)
	...
	Для каждого Колонка Из ЗначениеТЧ[0] Цикл
		...
		Если ЕстьДубльКолонки Тогда
			...
			ИндексДубликатов = ИндексДубликатов  + 1;
		КонецЕсли;
		ИменаКолонок.Вставить(ЗаголовокКолонки, ИмяКолонки);
		ЗаголовкиКолонок.Вставить(ИмяКолонки, ЗаголовокКолонки);

		ТЗСтало.Колонки.Добавить(ИмяКолонки,
	...
	Для каждого СтрокаКолонки Из ЗначениеТЧ Цикл
		...
		Для каждого Колонка Из СтрокаКолонки Цикл
			ИмяКолонки = ИменаКолонок.Получить(Колонка.Ключ);
			СтрокаТЗСтало[ИмяКолонки] = ЗаменитьПробельныеСимволы(Колонка.Значение);
		КонецЦикла;
	КонецЦикла;
...
Функция ПроизвестиСравнениеТаблицНаСервере(ИмяТЧ, ТабПарам, ЗначениеТЧ, МассивОшибок)
	...
	Для НомерСтроки = 0 По ТЗБыло.Количество() - 1 Цикл
		...
		Для каждого Колонка Из ТЗБыло.Колонки Цикл
			...
			Если Найти(ЗначениеПоиска, "*") > 0 Тогда
				МассивПодстрок = РазложитьСтрокуВМассивПодстрокБезКонтекста(ЗначениеПоиска, "*", Истина);
				Для каждого ПодстрокаПоиска Из МассивПодстрок Цикл
					...
					тОтбор.Значение     = ПодстрокаПоиска;
...
Процедура ЯЗакрываюОкноСЗаголовком(ЗаголовокОкна) Экспорт
	ОкноПриложения = Ванесса.НайтиОкноТестКлиентаПоЗаголовку(ЗаголовокОкна);
...
Процедура ЯЗакрываюТекущееОкно() Экспорт
	...
	Если Не ПолучилосьЗакрыть Тогда
		...
		АктивноеОкно = Ванесса.НайтиОкноТестКлиентаПоЗаголовку("1С:Предприятие");
		Если АктивноеОкно <> Неопределено Тогда
...
Процедура ЯБудуВыбиратьВнешнийФайл(Знач ИмяФайла) Экспорт
	...
	Если Найти(ИмяФайла, "$") <> 0  Тогда //есть переменные
...
&НаКлиенте
//И в поле с именем "ИмяПоля" я ввожу начало текущего месяца
//@ВПолеСИменемЯВвожуНачалоТекущегоМесяца(Парам01)
Процедура ВПолеСИменемЯВвожуНачалоТекущегоМесяца(ИмяПоля) Экспорт
	Текст = Формат(НачалоМесяца(ТекущаяДата()), "ДФ=dd.MM.yyyy");
	ВОткрытойФормеВПолеСИменемЯВвожуТекст(ИмяПоля, Текст);
КонецПроцедуры

&НаКлиенте
//И в поле с именем "ИмяПоля" я ввожу конец текущего месяца
//@ВПолеСИменемЯВвожуКонецТекущегоМесяца(Парам01)
Процедура ВПолеСИменемЯВвожуКонецТекущегоМесяца(ИмяПоля) Экспорт
	Текст = Формат(КонецМесяца(ТекущаяДата()), "ДФ=dd.MM.yyyy");
	ВОткрытойФормеВПолеСИменемЯВвожуТекст(ИмяПоля, Текст);
КонецПроцедуры

&НаКлиенте
//И в поле с именем "ИмяПоля" я ввожу начало следующего месяца
//@ВПолеСИменемЯВвожуНачалоСледующегоМесяца(Парам01)
Процедура ВПолеСИменемЯВвожуНачалоСледующегоМесяца(ИмяПоля) Экспорт
	Текст = Формат(НачалоМесяца(ДобавитьМесяц(ТекущаяДата(), 1)), "ДФ=dd.MM.yyyy");
	ВОткрытойФормеВПолеСИменемЯВвожуТекст(ИмяПоля, Текст);
КонецПроцедуры

&НаКлиенте
//И в поле с именем "ИмяПоля" я ввожу конец следующего месяца
//@ВПолеСИменемЯВвожуКонецСледующегоМесяца(Парам01)
Процедура ВПолеСИменемЯВвожуКонецСледующегоМесяца(ИмяПоля) Экспорт
...
Процедура ИзВыпадающегоСпискаЯВыбираюТочноеЗначение(ИмяРеквизита, Знач ВыбираемоеЗначение, ИскатьПоИмени = Ложь) Экспорт
	//МассивФорм = Ванесса.НайтиФормыТекущегоОкнаТестКлиента();
	ВыбираемоеЗначение = ПолучитьКорректныйТекстДляВставкиВПоле(ВыбираемоеЗначение);
...
Процедура ВПолеВвожуЗначениеГлобальнойПеременной(ИмяПоля, ИмяПеременной, ИскатьПоИмени = Ложь) Экспорт
	...
	Если ЗначениеПеременной = Неопределено Тогда
		...
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
	ВОткрытойФормеВПолеСЗаголовкомЯВвожуТекст(ИмяПоля, ЗначениеПеременной, ИскатьПоИмени);
КонецПроцедуры
...
Процедура ОбработичкОжиданияЯЖдуЧтоВОкнеВТаблицеКоличествоСтрокБудетВТеченииСекунд()
	...
	Попытка
		НужноеОкно = Ванесса.НайтиОкноТестКлиентаПоЗаголовку(ИмяОкнаОбработкаОжидания);
...
Процедура ПеременнаяИмеетЗначение(ИмяПеременной, Значение) Экспорт
	...
	Исключение
		ТекущееЗначение = Ванесса.ПолучитьСохраненноеЗначениеИзКонтекста(ИмяПеременной);
	...
	Если ТекущееЗначение <> Значение И Не Ванесса.СтрокаСоответствуетШаблону(ТекущееЗначение, Значение) Тогда
		ТекстСообщения = "Ожидали, что переменная <%1> будет равна <%2>, в т.ч. с учетом шаблонных *. Текущее значение <%3>";
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%1", ИмяПеременной);
...
Процедура ЗначениеПоляРавноЗначениюИзМакета(ИмяПоля, ИмяМакета, ИскатьПоИмени = Ложь) Экспорт
	...
	Если НРег(ТекущееЗначение) <> НРег(Текст) Тогда
		...
		Ожидаем.Что(ТекущееЗначение).Содержит(Текст);
		//если не было исключения, значит, содержание найдено и тогда ошибка, если количество строк не совпадает
		Если СтрЧислоСтрок(ТекущееЗначение) <> СтрЧислоСтрок(Текст) Тогда
...
Процедура ЯФиксируюФорму(ИмяФормы, ИскатьПоИмени = Ложь) Экспорт
	...
	Если ИскатьПоИмени Тогда
		ФормаПриложения = ТестовоеПриложение.НайтиОбъект(Тип("ТестируемаяФорма"), , ИмяФормы,
			Ванесса.Объект.КоличествоСекундПоискаОкна);
	Иначе
		ФормаПриложения = ТестовоеПриложение.НайтиОбъект(Тип("ТестируемаяФорма"), ИмяФормы, ,
			Ванесса.Объект.КоличествоСекундПоискаОкна);
	КонецЕсли;
	...
	Если ФормаПриложения = Неопределено Тогда
		ВсеФормы = Ванесса.НайтиВсеФормыТестКлиента(ТестовоеПриложение);//TODO нужно вычитать время поиска выше
...
&НаКлиентеНаСервереБезКонтекста
Функция РазложитьСтрокуВМассивПодстрокБезКонтекста(Знач Строка, Знач Разделитель = ",", Знач ПропускатьПустыеСтроки = Неопределено)
