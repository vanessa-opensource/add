...
Процедура ДляКаждойСтрокиТаблицыОтбораЯУстанавливаюОтборВСписке(ТабПарам,ВызыватьИсключениеЕслиНетТакогоФильтра = Истина) Экспорт
	...
	Для Каждого СтрокаФильтра Из ТабПарам Цикл
		...
		Исключение
			...
			ОписаниеОшибки = Ванесса.СтрШаблон_("Не удалось ввести значение %1 в поле отбора.
			|Возможно, не хватает права ""Ввод по строке"" для нужного метаданного.
			|%2", СтрокаФильтра.Кол3, ОписаниеОшибки);
			ВызватьИсключение ОписаниеОшибки; 	
		КонецПопытки;
