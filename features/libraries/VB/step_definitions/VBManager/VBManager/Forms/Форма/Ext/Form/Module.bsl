...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВызываюПроцедуруVanessaBehavior(Парам01)","ЯВызываюПроцедуруVanessaBehavior","Затем я вызываю процедуру Vanessa ADD ""ВычислитьPIDЭтогоСеансаСлужебный()""","","");
