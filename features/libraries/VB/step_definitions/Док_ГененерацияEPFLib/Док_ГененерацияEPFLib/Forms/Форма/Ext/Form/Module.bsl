...
Процедура ПередОкончаниемСценария() Экспорт
	...
	КонецЕсли;
	// TODO разобраться, зачем ранее здесь было написано Сообщить("ПОТОМ ВЕРНУТЬ!!!!!!!!") и возврат чего нужен??
...
Процедура ЯПишу(Стр) Экспорт
	Строка_ЯПишу = "и я пишу";
	Длина_ЯПишу = СтрДлина(Строка_ЯПишу);
	Если НРег(Лев(Стр, Длина_ЯПишу)) = Строка_ЯПишу Тогда
		Стр = Сред(Стр, Длина_ЯПишу + 1);
	КонецЕсли;
	ЯДобавляюСтрокуТекста(Стр);
КонецПроцедуры
