...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрывшемсяОкнеЯУказываюПутьКОбработкеVanessa_behaviorepf()","ВОткрывшемсяОкнеЯУказываюПутьКОбработкеVanessa_behaviorepf","И в открывшемся окне я указываю путь к обработке bddRunner.epf");
