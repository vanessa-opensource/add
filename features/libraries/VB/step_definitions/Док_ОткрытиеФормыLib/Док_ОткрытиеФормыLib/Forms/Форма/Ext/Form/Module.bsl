...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрывшемсяОкнеЯУказываюПутьКОбработкеVanessa_ADDepf()","ВОткрывшемсяОкнеЯУказываюПутьКОбработкеVanessa_ADDepf","И в открывшемся окне я указываю путь к обработке bddRunner.epf");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНабираюТекст(Парам01)","ЯНабираюТекст","И я набираю текст ""текст""");
...
//@ВОткрывшемсяОкнеЯУказываюПутьКОбработкеVanessa_ADDepf()
Процедура ВОткрывшемсяОкнеЯУказываюПутьКОбработкеVanessa_ADDepf() Экспорт
	Путь = Ванесса.Объект.КаталогИнструментов + "/bddRunner.epf";
