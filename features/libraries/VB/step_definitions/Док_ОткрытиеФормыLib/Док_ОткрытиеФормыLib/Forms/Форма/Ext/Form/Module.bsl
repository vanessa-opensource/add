...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВОткрывшемсяОкнеЯУказываюПутьКОбработкеBddRunnerepf()","ВОткрывшемсяОкнеЯУказываюПутьКОбработкеBddRunnerepf","И в открывшемся окне я указываю путь к обработке bddRunner.epf");
...
//@ВОткрывшемсяОкнеЯУказываюПутьКОбработкеBddRunnerepf()
Процедура ВОткрывшемсяОкнеЯУказываюПутьКОбработкеBddRunnerepf() Экспорт
