...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажмаюНаКнопкуVanessa_Behavior(Парам01)","ЯНажмаюНаКнопкуVanessa_Behavior","Когда я нажмаю на кнопку Vanessa-ADD ""Начать запись поведения""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВРеквизитеVanessa_BehaviorБудетСодержатьсяСтрока(Парам01,Парам02)","ВРеквизитеVanessa_BehaviorБудетСодержатьсяСтрока","Тогда В реквизите Vanessa-ADD ""СгенерированныйСценарий"" будет содержаться строка ""ываыва""");
