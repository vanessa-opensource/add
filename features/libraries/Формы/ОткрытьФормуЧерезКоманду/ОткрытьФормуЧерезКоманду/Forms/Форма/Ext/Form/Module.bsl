...
Процедура ЯОткрываюОсновнуюФормуОбработки(ИмяОбъекта) Экспорт
	ГлавноеОкноТестКлиента().ВыполнитьКоманду("e1cib/app/Обработка." + ИмяОбъекта);
КонецПроцедуры
...
Процедура ЯОткрываюОсновнуюФормуОтчета(ИмяОбъекта) Экспорт
	ГлавноеОкноТестКлиента().ВыполнитьКоманду("e1cib/app/Отчет." + ИмяОбъекта);
КонецПроцедуры
...
Процедура ЯОткрываюОсновнуюФормуСпискаСправочника(ИмяОбъекта) Экспорт
	ГлавноеОкноТестКлиента().ВыполнитьКоманду("e1cib/list/Справочник." + ИмяОбъекта);
КонецПроцедуры
...
Процедура ЯОткрываюОсновнуюФормуСпискаДокумента(ИмяОбъекта) Экспорт
	ГлавноеОкноТестКлиента().ВыполнитьКоманду("e1cib/list/Документ." + ИмяОбъекта);
КонецПроцедуры
...
Процедура ЯОткрываюОсновнуюФормуРегистраНакопления(ИмяОбъекта) Экспорт
	ГлавноеОкноТестКлиента().ВыполнитьКоманду("e1cib/list/РегистрНакопления." + ИмяОбъекта);
КонецПроцедуры
...
Процедура ЯОткрываюОсновнуюФормуРегистраСведений(ИмяОбъекта) Экспорт
	ГлавноеОкноТестКлиента().ВыполнитьКоманду("e1cib/list/РегистрСведений." + ИмяОбъекта);
КонецПроцедуры
...
Процедура ЯОткрываюОсновнуюФормуСпискаПланаВидовХарактеристик(ИмяОбъекта) Экспорт
	ГлавноеОкноТестКлиента().ВыполнитьКоманду("e1cib/list/ПланВидовХарактеристик." + ИмяОбъекта);
КонецПроцедуры
...
Процедура ЯОткрываюНавигационнуюСсылку(Стр) Экспорт
	ГлавноеОкноТестКлиента().ВыполнитьКоманду(Стр);
КонецПроцедуры

&НаКлиенте
Функция ГлавноеОкноТестКлиента()
	АктивноеОкно = Ванесса.ПолучитьГлавноеОкноИзТестовоеПриложение();
	Если АктивноеОкно = Неопределено Тогда
		ВызватьИсключение "Не удалось найти главное окно тест-клиента!";
	КонецЕсли;
