...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюОсновнуюФормуРегистраСведений(Парам01)","ЯОткрываюОсновнуюФормуРегистраСведений",
		...
		"UI.Формы.Открыть форму объекта");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюОсновнуюФормуПланаВидовХарактеристик(Парам01)","ЯОткрываюОсновнуюФормуПланаВидовХарактеристик",
		"Дано Я открываю основную форму плана видов характеристик ""ПланВидовХарактеристик1""",
		"Открывает основную форму плана видов характеристик по его имени в метаданных",
		"UI.Формы.Открыть форму объекта");
...
&НаКлиенте
//Дано Я открываю основную форму плана видов характеристик "ПланВидовХарактеристик1"
//@ЯОткрываюОсновнуюФормуПланаВидовХарактеристик(Парам01)
Процедура ЯОткрываюОсновнуюФормуПланаВидовХарактеристик(ИмяОбъекта) Экспорт
	АктивноеОкно = Ванесса.ПолучитьГлавноеОкноИзТестовоеПриложение();
