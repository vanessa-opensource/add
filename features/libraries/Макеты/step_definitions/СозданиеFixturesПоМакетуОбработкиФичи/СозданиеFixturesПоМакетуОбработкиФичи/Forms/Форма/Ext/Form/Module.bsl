...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗагружаюМакетСПеременными(Парам01,ТабПарам)","ЯЗагружаюМакетСПеременными","И я загружаю макет ""Макет1"" с переменными:" + Символы.ПС + "	| ИмяПеременнойИзМакета | НовоеНазваниеПеременнойВКонтексте |" + Символы.ПС + "	| ДругоеИмяПеременнойИзМакета | '' |","Загружает данные из макета MXL, полученного через плагин ГенераторДанных. Возможно явно указать, какие ссылки\наборы записей будут сохранены в контексте. Вторая колонка необязательна.","Данные");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВБазеОтсутствуетПользовательИБ(Парам01)","ВБазеОтсутствуетПользовательИБ","Когда В базе отсутствует пользователь ИБ ""ТестовыйПользователь""","Проверяется отсутствие пользователя информационной базы","Данные");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВБазеСуществуетПользовательИБ(Парам01)","ВБазеСуществуетПользовательИБ","Тогда В базе существует пользователь ИБ ""ТестовыйПользователь""","Проверяется наличие пользователя информационной базы","Данные");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУдаляюПользователяИБ(Парам01)","ЯУдаляюПользователяИБ","И Я удаляю пользователя ИБ ""ТестовыйПользователь""","Удаление пользователя информационной базы","Данные");
