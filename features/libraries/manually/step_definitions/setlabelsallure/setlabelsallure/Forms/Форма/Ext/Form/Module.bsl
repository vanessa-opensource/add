...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюSeverity(Парам01)","ЯУстанавливаюSeverity","Когда Я устанавливаю severity 'critical'","Полезный шаг для улучшения показа результатов тестирования. Например, для Allure.","Сценарии");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюНазваниеФичи(Парам01)","ЯУстанавливаюНазваниеФичи","Когда Я устанавливаю название фичи 'Мой дивный чудный мир'","Полезный шаг для улучшения показа результатов тестирования. Например, для Allure.","Сценарии");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюРучноеВыполнениеСценария()","ЯУстанавливаюРучноеВыполнениеСценария","Когда Я устанавливаю ручное выполнение сценария","Полезный шаг для улучшения показа результатов тестирования. Например, для Allure.","Сценарии");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюМеткеЗначение(Парам01,Парам02)","ЯУстанавливаюМеткеЗначение","Тогда Я устанавливаю метке 'issue' значение 'SUP-123'","Полезный шаг для улучшения показа результатов тестирования. Например, для Allure.","Сценарии");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВызываюИсключениеНеДано()","ЯВызываюИсключениеНеДано","И Я вызываю исключение не дано","Полезный шаг для улучшения показа результатов тестирования. Например, для Allure.","Сценарии");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюСсылкуСИменем()","ЯУстанавливаюСсылкуСИменем","И Я устанавливаю ссылку 'http://test/issue' с именем 'SUP-222'","Полезный шаг для улучшения показа результатов тестирования. Например, для Allure.","Сценарии");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУстанавливаюСсылкуСИменемСТипом()","ЯУстанавливаюСсылкуСИменемСТипом","И Я устанавливаю ссылку 'http://test/issue' с именем 'SUP-222' c типом 'tms'","Полезный шаг для улучшения показа результатов тестирования. Например, для Allure.","Сценарии");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодключаюФайлКШагу()","ЯПодключаюФайлКШагу","И Я подключаю файл '$workspaceRoot/fixtures/file.xls' к шагу 'id'","Полезный шаг для улучшения показа результатов тестирования. Например, для Allure.","Сценарии");
