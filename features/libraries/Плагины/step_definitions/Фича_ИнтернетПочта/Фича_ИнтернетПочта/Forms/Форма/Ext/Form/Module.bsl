...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		"Ответчает на первое сообщение из списка с установленным ранее отбором",
		"Плагины.ИнтернетПочта");
...
Процедура ЯОтвечаюНаЭтоСообщение() Экспорт
	...
	Ванесса.ПроверитьБольше(Контекст.ЗаголовкиПисем.Количество(), 0, "Ожидали, что список писем не пустой.");
