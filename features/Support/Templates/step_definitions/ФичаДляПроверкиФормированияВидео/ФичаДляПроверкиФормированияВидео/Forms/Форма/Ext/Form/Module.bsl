...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыполняюЕщёПростойШагСПараметром(Парам01)","ЯВыполняюЕщёПростойШагСПараметром","И     я выполняю ещё простой шаг c параметром 1");
...
//@ЯВыполняюЕщёПростойШагСПараметром(Парам01)
Процедура ЯВыполняюЕщёПростойШагСПараметром(Парам01) Экспорт
