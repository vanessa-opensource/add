...
Функционал: Проверка запуска простого сценария TestClient
	Как Разработчик
	Я Хочу чтобы чтобы у меня была возможность проверить запуск простого сценария в Vanessa-ADD в режиме TestClient
	...
	Сценарий: Запуск простого сценария TestClient
		...
		Тогда в VanessaADD в TestClient выполнился сценарий
