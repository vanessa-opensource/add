...
Сценарий: Тестирование документов - настроена проверка только избранных из отдельного файла настройки метаданных
...
Сценарий: Тест-клиент по спец-порту и Тестирование документов - настроена проверка только избранных из отдельного файла настройки метаданных

    И Я добавляю параметр "--testclient Admin::42769 --xddConfig <КаталогПроекта>/spec/fixtures/smoke-include-from-support.json" для команды "vrunner"
