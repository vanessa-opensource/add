...
Vanessa.ADD работает с гарантией на платформах 1С версии 8.3.6 и выше в режиме совместимости с 8.3.6 и выше.
  - Рекомендуется режим совместимости 8.3.8 или выше
Частично поддерживаются режимы совместимости от 8.2.16 до 8.3.5
