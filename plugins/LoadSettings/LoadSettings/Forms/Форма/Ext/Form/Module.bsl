...
Процедура ЗагрузитьНастройкиВРежимеКоманднойСтроки(ОбъектЯдра, СтруктураДействий) Экспорт
	...
	АдресПользовательскихНастроек = ?(АдресПользовательскихНастроек = Неопределено, ПолучитьЗначение(ПеременныеСреды, "usersettingspath"), АдресПользовательскихНастроек);
	...
	ПоставщикПользовательскихНастроек = ?(ПоставщикПользовательскихНастроек = Неопределено, ПолучитьЗначение(ПеременныеСреды, "usersettingsprovider"), ПоставщикПользовательскихНастроек);
