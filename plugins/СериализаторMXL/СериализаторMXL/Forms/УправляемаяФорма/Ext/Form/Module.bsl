...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия="ВыборВыгрузкиРегистровПоРегистратору" Тогда
		...
		Если ТипЗнч(Параметр)=Тип("Структура") 
			...
			СоответствиеПолногоИмениЭлементамДерева = новый Соответствие;
			СформироватьСоответствиеПолногоИмениЭлементамДерева(Объект.ДеревоМетаданных,СоответствиеПолногоИмениЭлементамДерева);
			
			УзелДокумента = СоответствиеПолногоИмениЭлементамДерева.Получить("Документы."+Параметр.Документ_ПолноеИмяМетаданных);
			...
			Для каждого стр из МассивВыбранныхДанных Цикл
				УзелДерева = СоответствиеПолногоИмениЭлементамДерева.Получить(стр.ИмяВидаРегистра+"."+стр.ПолноеИмяМетаданных);
	...
	ИначеЕсли ИмяСобытия="ВыборВыгрузкиПоСтруктуреПодчиненности" Тогда
		...
		Если ТипЗнч(Параметр)=Тип("Структура") 
			...
			Для каждого стр из Параметр.МассивВыбранныхДанных Цикл
				...
				УзелДерева = СоответствиеПолногоИмениЭлементамДерева.Получить(Ключ);
...
&НаКлиенте 
Процедура СформироватьСоответствиеПолногоИмениЭлементамДерева(ДеревоМетаданных,СоответствиеПолногоИмениЭлементамДерева,Знач Уровень=0 )
	...
	Для каждого Узел из УзлыДерева Цикл
		...
		Если Уровень > 0 Тогда
			...
			СоответствиеПолногоИмениЭлементамДерева.Вставить(ПолноеИмяМетаданных+"."+Узел.ПолноеИмяМетаданных,Узел);
		КонецЕсли;
		
		Уровень = Уровень+1;
		СформироватьСоответствиеПолногоИмениЭлементамДерева(Узел,СоответствиеПолногоИмениЭлементамДерева,Уровень);	
