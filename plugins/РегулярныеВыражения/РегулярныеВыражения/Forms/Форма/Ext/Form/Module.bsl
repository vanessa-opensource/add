...
//
&НаКлиенте
Функция СтрокаСоответствуетШаблону(Знач ПроверяемаяСтрока) Экспорт
	//Шаблон = ПодготовитьШаблонКИспользованиюВРегулярке(Шаблон); // TODO добавить вызов ПодготовитьШаблонКИспользованиюВРегулярке в клиентский код
	ПроверитьПодготовленность();
