...
Функция ТестКлиентПоУмолчанию() Экспорт
	...
	Если ЗначениеЗаполнено(ЗапущенныеТестКлиенты) Тогда
		ЗаписатьИнформациюВЖурналРегистрации("ТестКлиентПоУмолчанию", СтрШаблон("Был использован один из запущенных ранее тест клиентов.
														|ИмяПользователя: %1
														|Порт: %2
...
&НаСервереБезКонтекста
Процедура ЗаписатьИнформациюВЖурналРегистрации(ПостфиксСобытия, Знач Текст)
