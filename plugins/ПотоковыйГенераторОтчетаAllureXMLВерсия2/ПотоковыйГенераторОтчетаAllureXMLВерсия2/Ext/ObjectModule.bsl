...
Функция ОписаниеПлагина(ВозможныеТипыПлагинов) Экспорт
	...
	Результат.Вставить("Тип", ВозможныеТипыПлагинов.ПотоковыйГенераторОтчета);
...
Процедура ОбработатьПолученияРезультатаТестаНаСервере(Знач РезультатТеста) Экспорт
	...
	ИмяФайла = ПолучитьУникальноеИмяФайла(КаталогВывода);
