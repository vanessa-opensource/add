...
Процедура СлучайныйПорядокВыполнения() Экспорт
	...
	Если НЕ контекст = Неопределено Тогда
		контекст.СлучайныйПорядокВыполнения = Истина;
	КонецЕсли;
КонецПроцедуры
...
Процедура СтрогийПорядокВыполнения() Экспорт
	контекст = Контекст();	
	Если НЕ контекст = Неопределено Тогда
		контекст.СлучайныйПорядокВыполнения = Ложь;
...
Процедура ПродолжитьВыполнениеПослеПаденияТеста() Экспорт
	контекст = Контекст();	
	Если НЕ контекст = Неопределено  Тогда
		контекст.ПродолжитьВыполнениеПослеПаденияТеста = Истина;
	КонецЕсли;
КонецПроцедуры
...
Процедура ОстановитьВыполнениеПослеПаденияТестов() Экспорт	
	контекст = Контекст();
	Если НЕ контекст = Неопределено  Тогда
		контекст.ПродолжитьВыполнениеПослеПаденияТеста = Ложь;
	КонецЕсли;
КонецПроцедуры
...
Функция Контекст()
	...
	контекст = ?(ЗначениеЗаполнено(ТекущаяГруппа),ТекущаяГруппа,контекст);	
	контекст = ?(контекст = Неопределено И ЗначениеЗаполнено(КонтейнерТестов),КонтейнерТестов,контекст);
