...
Функция ОписаниеПлагина(КонтекстЯдра, ВозможныеТипыПлагинов) Экспорт
	...
	Если Не ПодходящийРежимСовместимостиПлатформы(КонтекстЯдра) Тогда
...
Функция ПодходящийРежимСовместимостиПлатформы(КонтекстЯдра)
	
	НеобходимаяВерсияПриложения =  "8.3.13";
	
	СистемнаяИнформация = Новый СистемнаяИнформация;
	Если Не КонтекстЯдра.ВерсияПриложенияБольшеИлиРавнаЧемЗаданная(СистемнаяИнформация.ВерсияПриложения, НеобходимаяВерсияПриложения) Тогда
		Возврат Ложь;
	КонецЕсли;

	ВерсияРежимаСовместимости = КонтекстЯдра.ВерсияРежимаСовместимости();
	
	Возврат КонтекстЯдра.ВерсияПриложенияБольшеИлиРавнаЧемЗаданная(ВерсияРежимаСовместимости, НеобходимаяВерсияПриложения);
