...
Функция ОписаниеПлагина(ВозможныеТипыПлагинов) Экспорт
	...
	Результат.Вставить("Идентификатор", "Заглушки");
	Результат.Вставить("Представление", "Заглушки");
...
Функция НачатьСозданиеОбъекта(ИмяМетаданных) Экспорт
...
Функция ЗавершитьСозданиеОбъекта() Экспорт
