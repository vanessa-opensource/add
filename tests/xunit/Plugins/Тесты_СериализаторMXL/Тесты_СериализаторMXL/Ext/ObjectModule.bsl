...
Процедура ТестДолжен_СоздатьДокументНаТекущуюДату() Экспорт
	...
	Утверждения.ПроверитьИстину(ТестовыеДанные.Свойство("Документ"), "Ожидали, что есть переменная 'Документ'");
	Утверждения.ПроверитьТип(ТестовыеДанные.Документ, "ДокументСсылка.Документ1");
	Утверждения.ПроверитьРавенствоДатСТочностью2Секунды(ТекущаяДатаСеанса(), ТестовыеДанные.Документ.Дата, "Разница между ТекущаяДатаСеанса() и ТестовыеДанные.Документ.Дата должна быть менее 2 секунд");
КонецПроцедуры
...
Процедура ТестДолжен_СоздатьПростойБизнесПроцесс() Экспорт
	...
	// Утверждения.ПроверитьРавенствоДатСТочностью2Секунды(ТекущаяДатаСеанса(), ТестовыеДанные.ПростойБП.Дата, "Разница между ТекущаяДатаСеанса() и ТестовыеДанные.ПростойБП.Дата должна быть менее 2 секунд");
