...
Функция ПолучитьСписокТестов() Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_СоздатьОбъектСЗаполненнымРеквизитомТипаПеречисление");
...
Процедура ТестДолжен_СоздатьОбъектСЗаполненнымРеквизитомТипаПеречисление() Экспорт
