...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.НачатьГруппу("Проверка создания простого справочника из JSON", Истина);
	НаборТестов.Добавить("ТестДолжен_СоздатьПростойСправочник_ИЗJSON_И_ПолучитьКоллекциюДанных");
	НаборТестов.Добавить("УдалитьСозданныеДанные", , "Удалить созданные данные");
...
Процедура ТестДолжен_СоздатьПростойСправочник_И_ПолучитьКоллекциюДанных() Экспорт
	ТестовыеДанные = СоздатьДанные("СозданиеПростогоСправочникаJSON");
	
	ПроверитьСозданиеПростогоСправочника(ТестовыеДанные);
КонецПроцедуры

&НаКлиенте
Процедура ТестДолжен_СоздатьПростойСправочник_ИЗJSON_И_ПолучитьКоллекциюДанных() Экспорт
	ТестовыеДанные = СоздатьДанные("СозданиеПростогоСправочникаJSON");
