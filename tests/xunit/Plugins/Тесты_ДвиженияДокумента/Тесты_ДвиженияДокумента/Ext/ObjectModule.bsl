...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.НачатьГруппу("Проверить движения документов", Истина);
	НаборТестов.Добавить("ТестДолжен_ПроверитьДвиженияДокументаБезНастройкиПроверок", , "Без настройки сравнения");
	НаборТестов.Добавить("ТестДолжен_ПроверитьДвиженияДокументаСНастройкойПроверок", , "С настройкой сравнения");
	...
	НаборТестов.Добавить(
			"ТестДолжен_ПроверитьДвиженияДокументаСНастройкойПроверокСИсключениеРегистраИзПроверокВторойСпособ", , 
	...
	НаборТестов.Добавить(
		"ТестДолжен_ПроверитьДвиженияДокументаСНастройкойПроверокДобавлениеВычисляемогоПоляНастройкаСверткиРегистров", ,
		"С настройкой сравнения - добавление вычисляемого поля и свертка регистров");
	НаборТестов.Добавить("ТестДолжен_ПроверитьДвиженияДокументаВызватьИсключениеПриОтсутствииДвижений", ,
