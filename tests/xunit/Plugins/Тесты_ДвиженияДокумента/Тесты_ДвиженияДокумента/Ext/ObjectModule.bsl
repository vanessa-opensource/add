...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.Добавить("ОТКЛЮЧЕНО_ТестДолжен_ПроверитьДвиженияДокументаБезНастройкиПроверок", , "Без настройки сравнения");
	НаборТестов.Добавить("ОТКЛЮЧЕНО_ТестДолжен_ПроверитьДвиженияДокументаСНастройкойПроверок", , "С настройкой сравнения");
	НаборТестов.Добавить("ОТКЛЮЧЕНО_ТестДолжен_ПроверитьДвиженияДокументаСНастройкойПроверокСИсключениеРегистраИзПроверок", , 
