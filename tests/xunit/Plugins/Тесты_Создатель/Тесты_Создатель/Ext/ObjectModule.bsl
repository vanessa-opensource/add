...
Процедура ПередЗапускомТеста() Экспорт
	...
	ФабрикаСоздателей.ПодключитьВсехСоздателей(КонтекстЯдра);
КонецПроцедуры
...
Процедура ТесСоздаетДокументСДвижениямиПлюсНеобходимыеСправочники() Экспорт
	...
	СоздательДокументаСДвижениями = Документы.ДокументСДвижениями;
	
	ТабЧасть = Новый Массив;
	Для Каждого ОписаниеСтрокиТЧ Из Окружение.Состав Цикл
		НоваяСтрокаТЧ = СоздательДокументаСДвижениями.Тест_ПараметрыТабЧасти(ОписаниеСтрокиТЧ);
		ТабЧасть.Добавить(НоваяСтрокаТЧ);
	КонецЦикла;
	
	П = СоздательДокументаСДвижениями.Тест_Параметры();
	...
	СозданныйДокумент = СоздательДокументаСДвижениями.Тест_Создать(П);
