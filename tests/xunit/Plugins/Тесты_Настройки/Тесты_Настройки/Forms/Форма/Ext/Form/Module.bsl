...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.Добавить("ТестДолжен_ПроверитьРаботуФункции_ЕстьНастройка2", , "Проверка работы функции ЕстьНастройка2");
	НаборТестов.Добавить("ТестДолжен_ПроверитьРаботуФункции_ЕстьНастройка", , "Проверка работы функции ЕстьНастройка");
	НаборТестов.Добавить("ТестДолжен_ПроверитьРаботуФункции_ЕстьНастройка_СценарийИзОписания", , "Проверка работы функции ЕстьНастройка по сценарию из описания");
...
&НаКлиенте
Процедура ТестДолжен_ПроверитьРаботуФункции_ЕстьНастройка2() Экспорт
	Перем бЕстьНастройка, ЗначениеНастройки;
	
	Настройки.ЗагрузитьНастройки(НастройкиДанныеКакСтруктура());
	
	ЗначениеНастройки = Неопределено;
	бЕстьНастройка = Настройки.ЕстьНастройка2("НесуществующийКлюч", ЗначениеНастройки);
	Ожидаем.Что(бЕстьНастройка, "Ожидали, что для несуществующего ключа настроек не будет найдено настроек, но это не так!")
		.ЭтоЛожь();
	
	ЗначениеНастройки = Неопределено;
	бЕстьНастройка = Настройки.ЕстьНастройка2("Ключ21", ЗначениеНастройки);
	...
	ЗначениеНастройки = Неопределено;
	бЕстьНастройка = Настройки.ЕстьНастройка2("Ключ1", ЗначениеНастройки);
	...
	ЗначениеНастройки = Неопределено;
	бЕстьНастройка = Настройки.ЕстьНастройка2("Ключ2.Ключ21", ЗначениеНастройки);
	...
	ЗначениеНастройки = Неопределено;
	бЕстьНастройка = Настройки.ЕстьНастройка2("Ключ3.Ключ32", ЗначениеНастройки);
	...
	ЗначениеНастройки = Неопределено;
	бЕстьНастройка = Настройки.ЕстьНастройка2("Ключ3.Ключ32.Ключ321", ЗначениеНастройки);
...
&НаКлиенте
Процедура ТестДолжен_ПроверитьРаботуФункции_ЕстьНастройка_СценарийИзОписания() Экспорт
	Перем бЕстьНастройка, ЗначениеНастройки;
