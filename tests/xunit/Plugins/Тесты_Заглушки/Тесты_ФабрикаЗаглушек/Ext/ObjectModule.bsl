...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.НачатьГруппу("Автозаполнение параметров");	
		НаборТестов.Добавить("Тест_РеквизтСправочникаАвтоматическиЗаполнился");
...
Процедура Тест_СозданиеЭлементовПлановВидовХарактеристик_НовыйИнтерфейс() Экспорт
	...
	Заглушки.НачатьСоздание("ПланВидовХарактеристик.ВидыСубконто1")
...
Процедура Тест_РеквизтСправочникаАвтоматическиЗаполнился() Экспорт

	Заглушки.НачатьСоздание("Справочники.Справочник1")
		.Реквизит("Реквизит2");
	Объект = Заглушки.Создать();
...
Процедура Тест_ВызваноИСключениеДляСоставногоТипа() Экспорт
	...
	Утверждения.ПроверитьМетодНеВыполнился(Заглушки, "Создать", "Автозаполнение не поддерживается в составных типах");
