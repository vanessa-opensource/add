...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.Добавить("Тест_ДолженПроверитьРавенствоТабличныхДокументовПоЭлементам");
...
Процедура Тест_ДолженПроверитьНеРавенствоТабличныхДокументовПоЭлементам() Экспорт
	...
	Макет2.Область(1,1,1,1).РазмещениеТекста = ТипРазмещенияТекстаТабличногоДокумента.Переносить;
	
	БылоИсключение = Ложь;
	Попытка
		УтвержденияПроверкаТаблиц.ПроверитьРавенствоТабличныхДокументовПоЭлементам(Макет1, Макет2, ЭлементыПроверить, "Таблицы 1 и 2 не должны совпадать, а они одинаковы!");
	Исключение
		Ошибка = ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
		БылоИсключение = Истина;
	КонецПопытки;
	...
	|Различия в таблицах:
	|Ожидали статус <ТаблицыСовпадают>, а получили <НеСовпадаютЗначенияВЯчейкеТаблицы>
	|Значение [К1:1]. Ожидали <РазмещениеТекста=Авто>, а получили <РазмещениеТекста=Переносить>
	|";
...
Процедура Тест_ДолженПроверитьРавенствоТабличныхДокументовПоЭлементам() Экспорт
	...
	УтвержденияПроверкаТаблиц.ПроверитьРавенствоТабличныхДокументовПоЭлементам(Макет1, Макет2, ЭлементыПроверить, "Таблицы 1 и 2 должны совпадать, а они различны!");
