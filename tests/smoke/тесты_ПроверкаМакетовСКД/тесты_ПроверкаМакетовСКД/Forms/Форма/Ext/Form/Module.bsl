...
&НаСервере
Функция ОбщиеМакеты()
	Возврат МодульОбъекта().ОбщиеМакеты(Объект.Настройки.ОтборПоПрефиксу, Объект.Настройки.ПрефиксОбъектов);
КонецФункции
...
Функция ГруппыМакетовМетаданных()
	Возврат МодульОбъекта().ГруппыМакетовМетаданных(Объект.Настройки.ОтборПоПрефиксу, Объект.Настройки.ПрефиксОбъектов);
КонецФункции
...
Функция ИмяСодержитПрефикс(Имя, Префикс)
	Возврат МодульОбъекта().ИмяСодержитПрефикс(Имя, Префикс);		
КонецФункции
