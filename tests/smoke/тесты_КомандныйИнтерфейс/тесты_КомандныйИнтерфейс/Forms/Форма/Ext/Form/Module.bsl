...
Процедура ЗаполнитьНаборТестов(НаборТестов, КонтекстЯдраПараметр) Экспорт
	...
	Для Каждого ЭлементСпискаЗначений  Из СписокДляСортировки Цикл
		...
		НаборТестов.Добавить(
			...
			Описание.ПредставлениеТеста + ": проверка элемента командного интерфейса");
	КонецЦикла;
...
Процедура ДобавитьОписаниеТеста(КоллекцияОписанийТестов, КомандныйИнтерфейс, ТекстЗаголовка)
	...
	Для Каждого ТекРаздел Из КомандныйИнтерфейс.НайтиОбъекты(Тип("ТестируемаяГруппаКомандногоИнтерфейса")) Цикл
		...
		Для Каждого ТекКнопка Из ТекРаздел.НайтиОбъекты() Цикл
			...
			ДобавляемоеОписание.Вставить("ПредставлениеТеста", КонтекстЯдра.СтрШаблон_("%1->%2->%3", ТекстЗаголовка, ТекРаздел.ТекстЗаголовка, ТекКнопка.ТекстЗаголовка));
