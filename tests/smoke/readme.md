...
`ГруппироватьТестыПоБазам` - настройка включающая группировку всех тестов по базам, имеет смысл задействовать данную настройку в случаях выполнения тестов на разныз базах.
