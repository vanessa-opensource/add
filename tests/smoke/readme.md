...
[Пример файла настройки исключений](https://github.com/silverbulleters/add/blob/develop/examples/smoke.bsp.json)
...
- настройки общих модулей согласно рекомендациям фирмы 1С
