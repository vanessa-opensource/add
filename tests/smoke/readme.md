...
- [Дымовые тесты](#дымовые-тесты)
  ...
  - [Дымовые тесты открытия/закрытия форм объектов метаданных и изменения метаданных](#дымовые-тесты-открытиязакрытия-форм-объектов-метаданных-и-изменения-метаданных)
    ...
    - [Исключения для версии ниже 4.1.Х.Х (более сложный способ) - не рекомендуется](#исключения-для-версии-ниже-41хх-более-сложный-способ---не-рекомендуется)
...
- [Тесты для проверки объектов метаданных на соответствие внутренним стандартам и [стандартам 1С](https://its.1c.ru/db/v8std)](./tests/smoke/smoke_tests_for_v8std.md)
<!-- /TOC -->
