...
а значение - это спец.структура с 3мя необязательными ключами.
- `Заголовки` - массив имен заголовков модальных окон
- `Поля` - массив заголовкой полей внутри внутри модального окна
