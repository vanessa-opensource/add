...
Процедура ТестироватьФормуНаКлиентеТестирования(ПолноеИмяФормы, ПараметрыФормы)
	...
	Исключение
		...
		ОткрытыеОкна = ПлагинТестКлиенты.ПолучитьСписокОткрытыхОкон(ТестКлиент);
	...
	ПлагинТестКлиенты.ИдентифицироватьОкноПредупреждение(ТестКлиент, ПереходПоКнопкеКомандногоИнтерфейса(), Ложь); // ЗакрытьВсеОткрытыеОкна есть внутри ИдентифицироватьОкноПредупреждение
