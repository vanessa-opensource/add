...
Функция ВключаемПоИмени(Знач КлючМетаданных, Знач ИмяМетаданного, Знач Настройки, Знач КонтекстЯдра = Неопределено)
	...
	ФмльтрИсключаемыхМетаданных = НайтиКоллекциюФильтрМетаданныхИзНастроек(КлючМетаданных, Настройки, "ИсключатьПоИмени");
...
Функция НайтиКоллекциюФильтрМетаданныхИзНастроек(Знач КлючМетаданных, Знач Настройки, Знач ИмяОбщейКоллекции)
	...
	Если Не ОбщаяКоллекция.Свойство(КлючМетаданных, ФильтрМетаданных ) Или Не ЗначениеЗаполнено(ФильтрМетаданных ) Тогда
		ФильтрМетаданных = Новый Массив;
	КонецЕсли;
	
	Возврат ФильтрМетаданных ;
