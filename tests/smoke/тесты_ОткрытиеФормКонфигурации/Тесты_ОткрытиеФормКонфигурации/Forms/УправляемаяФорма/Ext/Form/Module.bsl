...
Функция ДобавитьИменаМетаФормДляОдногоОбъектаМетаданного(СписокИменМетаФорм, ОсновнойОбъект, МетаОбъект,
	...
	//добавить все формы для отчётов, даже если есть только общие формы
	Если Метаданные.Отчеты.Найти(МетаОбъект.Имя) <> Неопределено Тогда
		Результат = Результат ИЛИ ДобавитьОбщиеФормыДляОтчетов(СписокИменМетаФорм, МетаОбъект);
	КонецЕсли;
...
Функция ДобавитьОбщиеФормыДляОтчетов(СписокИменМетаФорм, МетаОбъект)
	...
	Если МетаОбъект["ОсновнаяФорма"] = Неопределено И Метаданные.ОсновнаяФормаОтчета <> Неопределено Тогда
		СписокИменМетаФорм.Добавить(МетаОбъект.ПолноеИмя() + ".Форма");
		Результат = Истина;
	КонецЕсли;
	
	Если МетаОбъект["ОсновнаяФормаНастроек"] = Неопределено И Метаданные.ОсновнаяФормаНастроекОтчета <> Неопределено Тогда
		СписокИменМетаФорм.Добавить(МетаОбъект.ПолноеИмя() + ".ФормаНастроек");
		Результат = Истина;
	КонецЕсли;
	
	Если МетаОбъект["ОсновнаяФормаВарианта"] = Неопределено Тогда
		Если Метаданные.ОсновнаяФормаВариантаОтчета <> Неопределено Тогда
			СписокИменМетаФорм.Добавить(МетаОбъект.ПолноеИмя() + ".ФормаВарианта");
			Результат = Истина;
		КонецЕсли;
	Иначе
		СписокИменМетаФорм.Добавить(МетаОбъект["ОсновнаяФормаВарианта"].ПолноеИмя());
		Результат = Истина;
	КонецЕсли;
