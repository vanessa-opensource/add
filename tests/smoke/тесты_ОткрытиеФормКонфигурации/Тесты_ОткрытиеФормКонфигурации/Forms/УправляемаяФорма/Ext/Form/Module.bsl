...
Процедура ДобавитьТестыДляДокументовСервер(ОписанияТестов, НастройкиГруппыТестов,
	...
	ОтобранныеМетаданные = ОтобратьМетаданные("Документы", МенеджерМетаданного, Объект.Настройки, ОсновнойОбъект);
...
Процедура ЗагрузитьНастройки()
	...
	ПлагинНастроек.ПоказатьСвойстваВРежимеОтладки(Объект.Настройки);
КонецПроцедуры
