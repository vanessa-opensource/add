...
&НаСервереБезКонтекста
Функция ВключаемПоИмени(Знач КлючМетаданных, Знач МетаОбъект, Знач Настройки, Знач КонтекстЯдра = Неопределено)
...
Функция ОтобратьМетаданные(КлючМетаданных, МенеджерМетаданного, Настройки, ОсновнойОбъект, КонтекстЯдра)
	...
	Для Каждого МетаОбъект Из МенеджерМетаданного Цикл
		...
		Если ОсновнойОбъект.ЭтоУстаревшийМетаОбъектДляУдаления(МетаОбъект)
			...
			Или Не ВключаемПоИмени(КлючМетаданных, МетаОбъект, Настройки, КонтекстЯдра) Тогда
