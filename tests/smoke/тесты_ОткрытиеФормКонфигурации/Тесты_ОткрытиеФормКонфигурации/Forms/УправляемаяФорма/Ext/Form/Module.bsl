...
Процедура ТестироватьФормуНаКлиентеТестирования(ПолноеИмяФормы, ПараметрыФормы)
	...
	ПлагинТестКлиенты.ЗакрытьВсеОткрытыеОкна(ТестКлиент); // если есть модальные окна, они останутся 
	
	// первый вызов ИдентифицироватьОкноПредупреждение скорей всего на возврате выйдет 
	ПлагинТестКлиенты.ИдентифицироватьОкноПредупреждение(ТестКлиент, ПереходПоКнопкеКомандногоИнтерфейса(), ТекстыИсключенийСервер()); // ЗакрытьВсеОткрытыеОкна есть внутри ИдентифицироватьОкноПредупреждение
