...
Процедура ДобавитьТестДляМетаданного_ОдинОбъект(НаборТестов, Знач МетаОбъект, Знач имяТеста,
	...
	Для каждого МетаФорма Из МетаФормы Цикл
		...
		ДобавитьТестВНаборТестов(НаборТестов, ВремИмяТеста, ПараметрыТеста, ПредставлениеТеста);
...
Процедура ДобавитьТестВНаборТестов(НаборТестов, Знач ИмяТеста, Знач ПараметрыТеста, Знач ПредставлениеТеста)
