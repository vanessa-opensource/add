...
Процедура Тест_ПроверитьРежимБлокировкиОбъекта(ПолноеИмяМетаданного, Родитель, ИмяОперации) Экспорт
	...
	Если Настройки.Найти(ПолноеИмяМетаданного) <> Неопределено Тогда
	    ЗаписьЖурналаРегистрации("SmokeLockMode",УровеньЖурналаРегистрации.Информация,ОбъектМетаданных,,"Объект исключен из проверки");
		Возврат;
	КонецЕсли;
