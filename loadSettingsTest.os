...
Функция СоздатьОбщуюКоллекциюКомандЗапуска_Удалить()

	Рез = Новый Структура;

	Рез.Вставить("StartFeaturePlayer", Новый Структура("Р, А, ПоУмолчанию", "StartFeaturePlayer", "startfeatureplayer", Ложь));
	Рез.Вставить("КаталогФич", Новый Структура("Р, А, ПоУмолчанию", "КаталогФич", "featurepath", ""));
	Рез.Вставить("КаталогиБиблиотек", Новый Структура("Р, А, ПоУмолчанию", "КаталогиБиблиотек", "librarycatalogs", "Массив"));
	Рез.Вставить("СписокТеговИсключение", Новый Структура("Р, А, ПоУмолчанию", "СписокТеговИсключение", "ignoretags", "Массив"));
	Рез.Вставить("СписокТеговОтбор", Новый Структура("Р, А, ПоУмолчанию", "СписокТеговОтбор", "filtertags", "Массив"));
	Рез.Вставить("ВыгрузитьPIDTestManager", Новый Структура("Р, А, ПоУмолчанию", "ВыгрузитьPIDTestManager", "returnpidoftestmanager", Ложь));
	Рез.Вставить("ИмяФайлаPIDTestManager", Новый Структура("Р, А, ПоУмолчанию", "ИмяФайлаPIDTestManager", "filenamepidtestmanager", ""));
	Рез.Вставить("ИмяФайлаВнешнихКомандФреймворка", Новый Структура("Р, А, ПоУмолчанию", "ИмяФайлаВнешнихКомандФреймворка", "fileofcommand", ""));
	Рез.Вставить("ПриравниватьPendingКFailed", Новый Структура("Р, А, ПоУмолчанию", "ПриравниватьPendingКFailed", "pendingequalfailed", Ложь));
	Рез.Вставить("ОстановкаПриВозникновенииОшибки", Новый Структура("Р, А, ПоУмолчанию", "ОстановкаПриВозникновенииОшибки", "stoponerror", Ложь));
	Рез.Вставить("ДелатьСообщенияТранслитом", Новый Структура("Р, А, ПоУмолчанию", "ДелатьСообщенияТранслитом", "translatemassage", Ложь));
	Рез.Вставить("СоздаватьИнструкциюHTML", Новый Структура("Р, А, ПоУмолчанию", "СоздаватьИнструкциюHTML", "htmlcreate", Ложь));
	Рез.Вставить("СоздаватьИнструкциюMarkdown", Новый Структура("Р, А, ПоУмолчанию", "СоздаватьИнструкциюMarkdown", "markdowncreate", Ложь));
	Рез.Вставить("СоздаватьИнструкциюВидео", Новый Структура("Р, А, ПоУмолчанию", "СоздаватьИнструкциюВидео", "videcreate", Ложь));
	Рез.Вставить("ДелатьЛогВыполненияСценариевВЖР", Новый Структура("Р, А, ПоУмолчанию", "ДелатьЛогВыполненияСценариевВЖР", "logtogr", Истина));
	Рез.Вставить("ДелатьЛогВыполненияСценариевВТекстовыйФайл", Новый Структура("Р, А, ПоУмолчанию", "ДелатьЛогВыполненияСценариевВТекстовыйФайл", "logtotext", Ложь));
	Рез.Вставить("ИмяФайлаЛогВыполненияСценариев", Новый Структура("Р, А, ПоУмолчанию", "ИмяФайлаЛогВыполненияСценариев", "textlogname", ""));
	Рез.Вставить("ЗакрытьTestClientПослеЗапускаСценариев", Новый Структура("Р, А, ПоУмолчанию", "ЗакрытьTestClientПослеЗапускаСценариев", "closetestclient", Ложь));
	Рез.Вставить("КаталогOutputИнструкцияHTML", Новый Структура("Р, А, ПоУмолчанию", "КаталогOutputИнструкцияHTML", "htmlpath", ""));
	Рез.Вставить("КаталогOutputИнструкцияMarkdown", Новый Структура("Р, А, ПоУмолчанию", "КаталогOutputИнструкцияMarkdown", "markdownpath", ""));
	Рез.Вставить("КаталогOutputИнструкцияВидео", Новый Структура("Р, А, ПоУмолчанию", "КаталогOutputИнструкцияВидео", "videopath", ""));
	Рез.Вставить("ДелатьОтчетВоВнутреннемФормате", Новый Структура("Р, А, ПоУмолчанию", "ДелатьОтчетВоВнутреннемФормате", "simplereport", Ложь));
	Рез.Вставить("ДелатьОтчетВФорматеАллюр", Новый Структура("Р, А, ПоУмолчанию", "ДелатьОтчетВФорматеАллюр", "allurecreatereport", Ложь));
	Рез.Вставить("ОтображатьОтчетAllureВБраузере", Новый Структура("Р, А, ПоУмолчанию", "ОтображатьОтчетAllureВБраузере", "allureautoshow", Ложь));
	Рез.Вставить("КаталогИнструментов", Новый Структура("Р, А, ПоУмолчанию", "КаталогИнструментов", "instrpath", ""));
	Рез.Вставить("КаталогПроекта", Новый Структура("Р, А, ПоУмолчанию", "КаталогПроекта", "projectpath", ""));
	Рез.Вставить("КаталогOutputAllure", Новый Структура("Р, А, ПоУмолчанию", "КаталогOutputAllure", "allurepath", ""));
	Рез.Вставить("КаталогOutputAllureБазовый", Новый Структура("Р, А, ПоУмолчанию", "КаталогOutputAllureБазовый", "allurepathbase", ""));
	Рез.Вставить("ДелатьОтчетВФорматеjUnit", Новый Структура("Р, А, ПоУмолчанию", "ДелатьОтчетВФорматеjUnit", "junitcreatereport", Ложь));
	Рез.Вставить("КаталогOutputjUnit", Новый Структура("Р, А, ПоУмолчанию", "КаталогOutputjUnit", "junitpath", ""));
	Рез.Вставить("ДелатьОтчетВФорматеCucumberJson", Новый Структура("Р, А, ПоУмолчанию", "ДелатьОтчетВФорматеCucumberJson", "cucumbercreatereport", Ложь));
	Рез.Вставить("КаталогOutputCucumberJson", Новый Структура("Р, А, ПоУмолчанию", "КаталогOutputCucumberJson", "cucumberreportpath", ""));
	Рез.Вставить("ДобавлятьКИмениСценарияУсловияВыгрузки", Новый Структура("Р, А, ПоУмолчанию", "ДобавлятьКИмениСценарияУсловияВыгрузки", "addtofeaturefilter", Ложь));
	Рез.Вставить("СоздаватьПодкаталогВКаталогеAllureДляЭтойСборки", Новый Структура("Р, А, ПоУмолчанию", "СоздаватьПодкаталогВКаталогеAllureДляЭтойСборки", "createsubfolderforbuild", Ложь));
	Рез.Вставить("ВыгружатьСтатусВыполненияСценариевВФайл", Новый Структура("Р, А, ПоУмолчанию", "ВыгружатьСтатусВыполненияСценариевВФайл", "createlogs", Ложь));
	Рез.Вставить("ПутьКФайлуДляВыгрузкиСтатусаВыполненияСценариев", Новый Структура("Р, А, ПоУмолчанию", "ПутьКФайлуДляВыгрузкиСтатусаВыполненияСценариев", "logpath", ""));
	Рез.Вставить("ВыполнитьСценарии", Новый Структура("Р, А, ПоУмолчанию", "ВыполнитьСценарии", "vanessarun", Ложь));
	Рез.Вставить("ВыполнитьСценарииСТекущегоШага", Новый Структура("Р, А, ПоУмолчанию", "ВыполнитьСценарии", "vanessarunfromthisstep", Ложь));
	Рез.Вставить("НомерСтрокиДляЗапускаСТекущегоШагаСценария", Новый Структура("Р, А, ПоУмолчанию", "НомерСтрокиДляЗапускаСТекущегоШагаСценария", "stepnumber", ""));
	Рез.Вставить("ЗагрузитьСценарии", Новый Структура("Р, А, ПоУмолчанию", "ЗагрузитьСценарии", "loadscenarios", Ложь));
	Рез.Вставить("ЗавершитьРаботуСистемы", Новый Структура("Р, А, ПоУмолчанию", "ЗавершитьРаботуСистемы", "vanessashutdown", Ложь));
	Рез.Вставить("ИмяСборки", Новый Структура("Р, А, ПоУмолчанию", "ИмяСборки", "buildname", ""));
	Рез.Вставить("ДелатьСкриншотПриВозникновенииОшибки", Новый Структура("Р, А, ПоУмолчанию", "ДелатьСкриншотПриВозникновенииОшибки", "onerrorscreenshot", Ложь));
	Рез.Вставить("СниматьСкриншотКаждогоОкна1С", Новый Структура("Р, А, ПоУмолчанию", "СниматьСкриншотКаждогоОкна1С", "onerrorscreenshoteverywindow", Ложь));
	Рез.Вставить("КомандаСделатьСкриншот", Новый Структура("Р, А, ПоУмолчанию", "КомандаСделатьСкриншот", "commandscreenshot", ""));
	Рез.Вставить("КаталогOutputСкриншоты", Новый Структура("Р, А, ПоУмолчанию", "КаталогOutputСкриншоты", "outputscreenshot", ""));
	Рез.Вставить("ЗапускатьТестКлиентВРежимеОтладки", Новый Структура("Р, А, ПоУмолчанию", "ЗапускатьТестКлиентВРежимеОтладки", "testclientdebug", Ложь));
	Рез.Вставить("КлючиОтладки", Новый Структура("Р, А, ПоУмолчанию", "КлючиОтладки", "testclientdebugkeys", ""));
	Рез.Вставить("АдресОтладчика", Новый Структура("Р, А, ПоУмолчанию", "АдресОтладчика", "testclientdebugaddress", ""));
	Рез.Вставить("ВыполнятьШагиАссинхронно", Новый Структура("Р, А, ПоУмолчанию", "ВыполнятьШагиАссинхронно", "makestepsasync", Ложь));
	Рез.Вставить("ЗаписьВидеоКомандаНачатьЗаписьВидео", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоКомандаНачатьЗаписьВидео", "comandrecvideo", ""));
	Рез.Вставить("ЗаписьВидеоФайлКурсораМышки", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоФайлКурсораМышки", "mousecurfile", ""));
	Рез.Вставить("ЗаписьВидеоКаталогДляВременныхФайлов", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоКаталогДляВременныхФайлов", "tempfolderforvideo", ""));
	Рез.Вставить("ЗаписьВидеоФайлВодянойЗнак", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоФайлВодянойЗнак", "watermarkfile", ""));
	Рез.Вставить("ЗаписьВидеоКомандаFfmpeg", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоКомандаFfmpeg", "ffmpegcomand", ""));
	Рез.Вставить("ЗаписьВидеоКомандаConvert", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоКомандаConvert", "convertcomand", ""));
	Рез.Вставить("ЗаписьВидеоКаталогМузыки", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоКаталогМузыки", "musicpath", ""));
	Рез.Вставить("ЗаписьВидеоДелатьНаложениеTTS", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоДелатьНаложениеTTS", "dotts", Ложь));
	Рез.Вставить("ЗаписьВидеоПутьКДвижкуTTS", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоПутьКДвижкуTTS", "audioenginetts", ""));
	Рез.Вставить("ЗаписьВидеоИмяTTS", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоИмяTTS", "ttsvoice", ""));
	Рез.Вставить("ЗаписьВидеоСловарьЗамен", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоСловарьЗамен", "changewordslib", ""));
	Рез.Вставить("ЗаписьВидеоСловарьЗаменСписок", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоСловарьЗаменСписок", "changewordsliblist", ""));
	Рез.Вставить("ЗаписьВидеоЭкранШирина", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоЭкранШирина", "screenwidth", ""));
	Рез.Вставить("ЗаписьВидеоЭкранВысота", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоЭкранВысота", "screenheight", ""));
	Рез.Вставить("ЗаписьВидеоКоличествоКадров", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоКоличествоКадров", "fps", ""));
	Рез.Вставить("ЗаписьВидеоПодсвечиватьАктивныеЭлементыФорм", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоПодсвечиватьАктивныеЭлементыФорм", "showframe",
Ложь));
	Рез.Вставить("ЗаписьВидеоПеремещатьКурсорМышкиКАктивномуЭлементуФормы", Новый Структура("Р, А, ПоУмолчанию", "ЗаписьВидеоПеремещатьКурсорМышкиКАктивномуЭлементуФормы", "movemouse", Ложь));
	Рез.Вставить("ВерсияПлатформыДляГенерацииEPF", Новый Структура("Р, А, ПоУмолчанию", "ВерсияПлатформыДляГенерацииEPF", "platformversiongenerateepf", ""));
	Рез.Вставить("ДополнительныеПараметры", Новый Структура("Р, А, ПоУмолчанию", "ДополнительныеПараметры", "dopparams", ""));
	Рез.Вставить("КлиентыТестирования", Новый Структура("Р, А, ПоУмолчанию", "КлиентыТестирования", "testclienttable", ""));
	Рез.Вставить("ТаймаутЗапуска1С", Новый Структура("Р, А, ПоУмолчанию", "ТаймаутЗапуска1С", "testclienttimeout", "25"));
	Рез.Вставить("ДиапазонПортовTestclient", Новый Структура("Р, А, ПоУмолчанию", "ДиапазонПортовTestclient", "testclientports", ""));
...
Функция СоздатьОбщуюКоллекциюКомандЗапуска()
        ...
        Рез.Вставить("ВыгрузитьPIDTestManager",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
        ...
        Рез.Вставить("ДелатьОтчетВоВнутреннемФормате",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
        ...
        Рез.Вставить("ДелатьОтчетВФорматеjUnit", ???
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ДелатьОтчетВФорматеjUnit", "junitcreatereport", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("КаталогOutputjUnit",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "КаталогOutputjUnit", "junitpath", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ДелатьОтчетВФорматеCucumberJson",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ДелатьОтчетВФорматеCucumberJson", "cucumbercreatereport", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("КаталогOutputCucumberJson",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "КаталогOutputCucumberJson", "cucumberreportpath", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ДобавлятьКИмениСценарияУсловияВыгрузки",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ДобавлятьКИмениСценарияУсловияВыгрузки", "addtofeaturefilter", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("СоздаватьПодкаталогВКаталогеAllureДляЭтойСборки",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
        ...
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ВыгружатьСтатусВыполненияСценариевВФайл", "createlogs", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ПутьКФайлуДляВыгрузкиСтатусаВыполненияСценариев",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ПутьКФайлуДляВыгрузкиСтатусаВыполненияСценариев", "logpath", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ВыполнитьСценарии",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ВыполнитьСценарии", "vanessarun", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ВыполнитьСценарииСТекущегоШага",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
        ...
        Рез.Вставить("ЗагрузитьСценарии",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗагрузитьСценарии", "loadscenarios", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗавершитьРаботуСистемы",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
        ...
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ДелатьСкриншотПриВозникновенииОшибки", "onerrorscreenshot", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("СниматьСкриншотКаждогоОкна1С",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "СниматьСкриншотКаждогоОкна1С", "onerrorscreenshoteverywindow", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("КомандаСделатьСкриншот",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "КомандаСделатьСкриншот", "commandscreenshot", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("КаталогOutputСкриншоты",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "КаталогOutputСкриншоты", "outputscreenshot", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗапускатьТестКлиентВРежимеОтладки",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗапускатьТестКлиентВРежимеОтладки", "testclientdebug", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("КлючиОтладки",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "КлючиОтладки", "testclientdebugkeys", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("АдресОтладчика",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "АдресОтладчика", "testclientdebugaddress", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ВыполнятьШагиАссинхронно",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ВыполнятьШагиАссинхронно", "makestepsasync", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоКомандаНачатьЗаписьВидео",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоКомандаНачатьЗаписьВидео", "comandrecvideo", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоФайлКурсораМышки",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоФайлКурсораМышки", "mousecurfile", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоКаталогДляВременныхФайлов",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоКаталогДляВременныхФайлов", "tempfolderforvideo", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоФайлВодянойЗнак",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоФайлВодянойЗнак", "watermarkfile", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоКомандаFfmpeg",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоКомандаFfmpeg", "ffmpegcomand", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоКомандаConvert",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоКомандаConvert", "convertcomand", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоКаталогМузыки",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоКаталогМузыки", "musicpath", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоДелатьНаложениеTTS",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоДелатьНаложениеTTS", "dotts", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоПутьКДвижкуTTS",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоПутьКДвижкуTTS", "audioenginetts", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоИмяTTS",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоИмяTTS", "ttsvoice", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоСловарьЗамен",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоСловарьЗамен", "changewordslib", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоСловарьЗаменСписок",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоСловарьЗаменСписок", "changewordsliblist", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоЭкранШирина",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоЭкранШирина", "screenwidth", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоЭкранВысота",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоЭкранВысота", "screenheight", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоКоличествоКадров",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоКоличествоКадров", "fps", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоПодсвечиватьАктивныеЭлементыФорм",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоПодсвечиватьАктивныеЭлементыФорм", "showframe", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ЗаписьВидеоПеремещатьКурсорМышкиКАктивномуЭлементуФормы",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ЗаписьВидеоПеремещатьКурсорМышкиКАктивномуЭлементуФормы", "movemouse", Ложь, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ВерсияПлатформыДляГенерацииEPF",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ВерсияПлатформыДляГенерацииEPF", "platformversiongenerateepf", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ДополнительныеПараметры",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ДополнительныеПараметры", "dopparams", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("КлиентыТестирования",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "КлиентыТестирования", "testclienttable", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ТаймаутЗапуска1С",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ТаймаутЗапуска1С", "testclienttimeout", "25", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ДиапазонПортовTestclient",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "ДиапазонПортовTestclient", "testclientports", "", Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("СоздаватьОбластиПриГенерацииКода",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
                "СоздаватьОбластиПриГенерацииКода", "generateareaforsteps", Истина, Ложь, Ложь, Ложь, Ложь, Ложь, ""));
        Рез.Вставить("ОсновнойЯзык",
        Новый Структура("Р, А, ПоУмолчанию, УстанавливатьЕслиЗаполнено, ЭтоМассив, УстанавливатьЕслиИстина, ПреобразоватьПуть, ПростоУстановить, РазрешаюшийКлюч",
