...
### 3. Каким образом увидеть лог выполнения тестов или фич, сценариев и шагов, или подробный лог при выполнении в командной строке, например, в логе CI-сервера - Jenkins, Gitlab и т.п.
...
* После включения данных настроек в логе выполнения будут видны пути выполняемых тестов\фич и названия выполняемых сценариев
...
* (только для bdd) Также можно включить более подробный лог с показом выполнения каждого шага, а не только сценариев
