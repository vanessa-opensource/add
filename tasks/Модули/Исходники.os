...
//
Функция ПапкиВнешнихФайлов(Знач ДобавлятьКаталогСборкиКорневыхФайлов = Истина) Экспорт
	// код из init.os
	// Результат = Новый Массив;
	// Результат.Добавить("features");
	// Результат.Добавить("tools");
	// Результат.Добавить("lib");
	// Результат.Добавить("plugins");
	// Результат.Добавить("vendor");
	// Результат.Добавить("lib/TemplateEpf");
	// Возврат Результат;

	Если ДобавлятьКаталогСборкиКорневыхФайлов Тогда
		Если МассивПутей[0] <> КаталогСоответствующийКорню Тогда
...
КаталогСоответствующийКорню = Настройки["root"];
