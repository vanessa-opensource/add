...
Процедура КнопкаИнструментыБраузерИзвестныхШагов(Кнопка)
	...
	//ПараметрыФормы.Вставить("ЯзыкГенератораGherkin", ЭтотОбъект.ЯзыкГенератораGherkin);
	//ПараметрыФормы.Вставить("КаталогИнструментов", ЭтотОбъект.КаталогИнструментов);
