...
Процедура смв_ОткрытьФорму(ИмяФормы
	...
	Если Найти(ИмяФормы, ".") = 0 Тогда
		...
		ИмяФормы = Объект.ПараметрыКлиентСервер.ПутьКФормам + ИмяФормы;
...
Процедура смв_ПоместитьФайлы(ОписаниеОповещенияОЗавершении, 
	...
	#Если ВебКлиент Тогда
		...
		Если ПроверитьРасширениеРаботыСФайламиВебКлиент() Тогда
			...
			НачатьПомещениеФайлов(ОписаниеОповещенияОЗавершении, ПомещаемыеФайлы, , Ложь, Объект.ПараметрыКлиентСервер.УникальныйИдентификатор);
	...
	#Иначе
		...
		Если МодальностьЗапрещена Тогда
			...
			Выполнить("НачатьПомещениеФайлов(ОписаниеОповещенияОЗавершении, ПомещаемыеФайлы, , Ложь, Объект.ПараметрыКлиентСервер.УникальныйИдентификатор)");
			
		ИначеЕсли ПоместитьФайлы(ПомещаемыеФайлы, ПомещенныеФайлы, , Ложь, Объект.ПараметрыКлиентСервер.УникальныйИдентификатор) Тогда
...
Процедура смв_ПоместитьФайлыЧерезДиалог(ОписаниеОповещенияОЗавершении, 
	...
	#Если ВебКлиент Тогда
		...
		Если ПроверитьРасширениеРаботыСФайламиВебКлиент() Тогда
			...
			НачатьПомещениеФайлов(ОписаниеОповещенияОЗавершении, , ДиалогОткрытияФайла, Истина, Объект.ПараметрыКлиентСервер.УникальныйИдентификатор);
	...
	#Иначе
		...
		Если МодальностьЗапрещена Тогда
			...
			Выполнить("НачатьПомещениеФайлов(ОписаниеОповещенияОЗавершении, , ДиалогОткрытияФайла, Истина, Объект.ПараметрыКлиентСервер.УникальныйИдентификатор);");
			
		ИначеЕсли ПоместитьФайлы(, ПомещенныеФайлы, ДиалогОткрытияФайла, Истина, Объект.ПараметрыКлиентСервер.УникальныйИдентификатор) Тогда
