...
Процедура КаталогПроектаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыОбъекта   = Новый Структура("МножественныйВыбор, ИмяРеквизитаОбъекта, ИмяРеквизитаФормы", Ложь, "КаталогПроекта", "");
	ОписаниеОповещения = АСинк().смв_НовыйОписаниеОповещения("КаталогВыборЗавершение", ЭтаФорма, ПараметрыОбъекта);
