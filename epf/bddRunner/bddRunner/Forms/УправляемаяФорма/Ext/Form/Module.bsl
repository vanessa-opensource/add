...
Функция НайтиМакетВКаталогеПроекта(ИмяМакета) Экспорт
	...
	Если ЭтоФайлДжейсон(ДвоичныеДанныеИлиПутьФайла) Тогда
...
&НаСервереБезКонтекста
Функция ПолучитьТекстовыйДокументНаСервере(ДвоичныеДанныеИлиПутьФичи)
	ИмяВременногоФайла = Неопределено;
	ПутьФайла = ПутьФайлаПоДвоичнымДаннымСервер(ДвоичныеДанныеИлиПутьФичи, "json", ИмяВременногоФайла);
