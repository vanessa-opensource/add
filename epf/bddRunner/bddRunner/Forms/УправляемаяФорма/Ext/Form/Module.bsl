...
&НаКлиенте
Функция ДобавитьJSONКТекущемуШагу(ТекстJSON, Наименование) Экспорт
	
    ПлагинАллюр2Отчет = Плагин("Аллюр2Отчет");
    ПлагинАллюр2Отчет.ДобавитьJSONКТекущемуШагу(ТекстJSON, Наименование);
    
КонецФункции

&НаКлиенте
Функция ДобавитьТекстКТекущемуШагу(Текст, Наименование) Экспорт
	
    ПлагинАллюр2Отчет = Плагин("Аллюр2Отчет");
    ПлагинАллюр2Отчет.ДобавитьТекстКТекущемуШагу(Текст, Наименование);
    	
КонецФункции

&НаКлиенте
Функция ДобавитьXMLКТекущемуШагу(ТекстXML, Наименование) Экспорт
	
    ПлагинАллюр2Отчет = Плагин("Аллюр2Отчет");
    ПлагинАллюр2Отчет.ДобавитьXMLКТекущемуШагу(ТекстXML, Наименование);
