...
//Необходима для работы автотестирования VB
&НаКлиенте
...
Процедура ПриОткрытии(Отказ)
	...
	Если Версия836ИлиВыше Тогда
		Обработчик_ПриОткрытииЗавершение = Вычислить("Новый ОписаниеОповещения(""ПриОткрытииЗавершение"", ЭтаФорма)");
...
Процедура КаталогИнструментовСлужебныйПриИзменении(Элемент)
	Если Версия836ИлиВыше Тогда
		Обработчик_ПодключитьБиблиотекуРаботыСВидео = Вычислить("Новый ОписаниеОповещения(""Обработчик_ПодключитьБиблиотекуРаботыСВидео"", ЭтаФорма)");
		ЗагрузитьПлагины(Истина, Обработчик_ПодключитьБиблиотекуРаботыСВидео);
	Иначе
...
&НаКлиенте
Процедура Обработчик_ПодключитьБиблиотекуРаботыСВидео(Знач НенужноеЗначение, Знач ДополнительныеПараметры) Экспорт
	ПодключитьБиблиотекуРаботыСВидео();
КонецПроцедуры
