...
//Процедура ПоказатьПараметрыПакетногоРежимаВРежимеОтладки(Знач ПараметрыПараметр, Знач Отступ = "")
...
//					
//						Отладка(Отступ + "количество = <" + Значение.Количество() + ">");
//						ПоказатьПараметрыПакетногоРежимаВРежимеОтладки(Значение, Отступ + "   ");
//				Иначе
//						Отладка(Отступ + "Значение = <" + Значение + ">");
//				КонецЕсли;
//			КонецЦикла;
//		Иначе
...
//					ТипЗнч(Значение) = Тип("ФиксированнаяСтруктура") Тогда
//					
//						Отладка(Отступ + "Ключ <" + КлючЗначение.Ключ + ">, количество = <" + Значение.Количество() + ">");
//						ПоказатьПараметрыПакетногоРежимаВРежимеОтладки(Значение, Отступ + "   ");
//				Иначе
//						Отладка(Отступ + "Ключ <" + КлючЗначение.Ключ + ">, Значение = <" + Значение + ">");
//				КонецЕсли;
//			КонецЦикла;
//		КонецЕсли;	
//		Сообщить(Отступ + "");
