...
// Функция - Возвращает истина еслли в настройках задан признак группировки тестов по базам
// 
// Возвращаемое значение:
//  Булево - 
//
&НаКлиенте
Функция ГруппироватьТестыПоБазам() Экспорт 
	Перем ГруппироватьТестыПоБазам;

	ПлагинНастроек = Плагин("Настройки");
	ПлагинНастроек.Обновить();

	ПлагинНастроек.ПолучитьНастройки().Свойство("ГруппироватьТестыПоБазам", ГруппироватьТестыПоБазам);

	Возврат ГруппироватьТестыПоБазам = Истина;
КонецФункции
