...
&НаКлиенте
Перем ГлобальныйКлиентскийКонтекст;
...
#Область Глобальный_Клиентский_контекст

&НаКлиенте
Процедура СохранитьГлобальныйКлиентскийКонтекст(Знач Контекст) Экспорт
	
	ГлобальныйКлиентскийКонтекст = Контекст;
	
КонецПроцедуры

&НаКлиенте
Функция ПолучитьГлобальныйКлиентскийКонтекст() Экспорт
	
	Возврат ГлобальныйКлиентскийКонтекст;
