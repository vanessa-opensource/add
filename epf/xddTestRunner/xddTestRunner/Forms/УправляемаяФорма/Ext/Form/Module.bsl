...
Процедура ВходВОбластьНаСервере(Знач ОбластьДанных) 
	МРаботаВМоделиСервиса = ОбщегоНазначения.ОбщийМодуль("РаботаВМоделиСервиса"); // мало ли модуля может не быть (если конфы самописные)
	МСтроковыеФункцииКлиентСервер = ОбщегоНазначения.ОбщийМодуль("СтроковыеФункцииКлиентСервер");
