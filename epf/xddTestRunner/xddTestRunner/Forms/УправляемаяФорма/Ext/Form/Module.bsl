...
Функция ИспользуютсяСинхронныеВызовыРасширенийПлатформыИВнешнихКомпонент(ВерсияПриложения)
	...
	Если Метаданные[ИмяСвойства] = Метаданные.СвойстваОбъектов[ИмяСвойства].Использовать Тогда
		Возврат Истина;
	КонецЕсли;

	Если Метаданные[ИмяСвойства] = Метаданные.СвойстваОбъектов[ИмяСвойства].ИспользоватьСПредупреждениями Тогда
		Возврат Истина;
	КонецЕсли;
