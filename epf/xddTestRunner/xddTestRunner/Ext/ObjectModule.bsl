...
Функция ВерсияПриложенияБольшеИлиРавнаЧемЗаданная(Версия1, Версия2) Экспорт
	...
	Если Версия1 = РежимСовместимостиНеИспользовать() Или Версия2 = РежимСовместимостиНеИспользовать() Тогда
		Возврат Истина;  
	КонецЕсли;
...
Функция РежимСовместимостиНеИспользовать()
	Возврат Строка(Метаданные.СвойстваОбъектов.РежимСовместимости.НеИспользовать);	
КонецФункции 
