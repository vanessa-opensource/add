...
Функция ПолучитьПлагины() Экспорт
	...
	Если РезультатПоиска = Неопределено Тогда
		ВызватьИсключение НСтр("ru='Подсистему ""Plugins"" не удалось найти или она не подчинена подсистеме ""xUnitFor1C""';en='Subsystem ""Plugins"" could not find or it is not subject to the subsystem ""xUnitFor1C""'");
	КонецЕсли;
